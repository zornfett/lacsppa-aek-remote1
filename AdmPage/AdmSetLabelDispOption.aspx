<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdmSetLabelDispOption.aspx.cs" Inherits="Virweb2.AdmPage.AdmSetLabelDispOption" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    function doseltdbyid(obj_id)
    {
	  ...
	  {		
	      case "TD_GEN":
		      Disp_GEN.style.display="";
		      TD_GEN.style.color = "#990066";
              //TD_GEN.style.cursor="auto";
		      break;
	      case "TD_COL":    
		  	 Disp_COL.style.display="";
		  	 TD_COL.style.color = "#990066";
             //TD_COL.style.cursor="auto";
		     break;
		  case "TD_CUM":    
		  	 Disp_CUM.style.display="";
		  	 TD_CUM.style.color = "#990066";
             //TD_CUM.style.cursor="auto";
		     break;   
		  case "TD_IDN":    
		  	 Disp_IDN.style.display="";
		  	 TD_IDN.style.color = "#990066";
             //TD_IDN.style.cursor="auto";
		     break;    
		  case "TD_CDER":    
		  	 Disp_CDER.style.display="";
		  	 TD_CDER.style.color = "#990066";
             //TD_CDER.style.cursor="auto";
		     break;    
		  case "TD_RESOURCE":    
		  	 Disp_RESOURCE.style.display="";
		  	 TD_RESOURCE.style.color = "#990066";
             //TD_RESOURCE.style.cursor="auto";
		     break;   	
		  case "TD_POS":    
		  	 Disp_POS.style.display="";
		  	 TD_POS.style.color = "#990066";
             //TD_POS.style.cursor="auto";
		     break;    
		  case "TD_CDER08":    
		  	 Disp_CDER08.style.display="";
		  	 TD_CDER08.style.color = "#990066";
             //TD_CDER08.style.cursor="auto";
		     break;         
		  case "TD_BUTTON":    
		  	 Disp_BUTTON.style.display="";
		  	 TD_BUTTON.style.color = "#990066";
    ...
    <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="100%" >
      <tr valign="middle" style="height:30px; background-color: #EAF4FF">
        ...
        <td align="left" valign="middle" width="60%">        
            <asp:Label ID="Info" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="blue">Label Settings</asp:Label>
        </td>
    ...
    <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="100%" >
      <tr class="tab_bar">
        <td>
            <table id="TABLE_Label">
                <tr id="tr_info">
                	<td id="TD_GEN" style="color:#990066;" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>Global Settings</u></b>
					</td>
					<td id="TD_COL" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>Lists</u></b>
					</td>
					<td id="TD_CUM" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u><asp:Label ID="Tab_Client" runat="server" Text="Client"></asp:Label> Info</u></b>
					</td>
					<td id="TD_RESOURCE" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u><asp:Label ID="Tab_Resource" runat="server" Text="Resource"></asp:Label></u></b>
					</td>
					<td id="TD_IDN" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u><asp:Label ID="Tab_CaseNotes" runat="server" Text="Client"></asp:Label></u></b>
					</td>
					<td id="TD_CDER" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>CDER</u></b>
					</td>
					<td id="TD_POS" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>POS</u></b>
					</td>
					<td id="TD_CDER08" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>CDER08</u></b>
					</td>
					<td id="TD_BUTTON" class="tab_sel" onclick="doseltd(this);"
						width="110">
                        <b><u>Buttons</u></b>
					</td>
            </table>
      ...
      <tr>
        ...
        <td class="td_unline" width="160" style="height: 20px">
            <asp:TextBox ID="label_name" runat="server" CssClass="inface" Style="width: 160px" ReadOnly="true"></asp:TextBox>
        </td>
        <td style="width:5%"></td>
        ...
        <td class="td_unline" width="300" style="height: 20px">
            <asp:TextBox ID="label_description" runat="server" CssClass="inface" Style="width: 300px" ReadOnly="true"></asp:TextBox>
        </td>                         
      </tr>
      <tr style="height:8px">
        <td colspan="7"></td> 
    ...
    <div id="maindiv" align="center" style="position:relative;WIDTH:100%;Height:450px; overflow: auto "> 
	    <div id="Disp_GEN">
		    <div style="width:100%;height:35px;">	
	 		...
	 		<div>
	 			  <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">			        
	 		        <tr class="tr_common">
	 			      <td style="WIDTH: 180px;" align="right" class="td_label"><b>Client:</b></td>
	 			      ...
	 			      <td style="WIDTH: 180px;" align="right" class="td_label"><b>Resource:</b></td>
	 			      <td style="Width: 5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px;">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Case Manager:</b></td>
	 			      <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_casemanager" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right"class="td_label"><b>UCI:</b></td>
	 			      <td style="Width:5px"></td>
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Case Notes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_idnotes" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" class="td_label"><b></b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			      </td>
	 			    </tr>
		...
		<div id="Disp_COL" style="DISPLAY: none">
		    <div style="width:100%; height:55px">	
				  <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">
				  <tr class="tr_common">
				      <td colspan="2" align="center" style="WIDTH: 485px"></td>
				      <td colspan="2" align="left" style="WIDTH: 485px">
			      ...
			      <tr class="tr_common">
	 		          ...
	 		          <td align="left" style="WIDTH: 120px"><font color="#3366ff"><b>No Display</b></font></td>
				      <td align="center" style="WIDTH: 365px">
	 		...
	 		<div>
				  <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">
	 		      <tr class="tr_common">
	 			      <td style="WIDTH: 180px;" align="right" class="td_label"><b>Icon:</b></td>
	 			       <td style="Width:5px"></td>
	 			      ...
	 			      <td style="WIDTH: 180px;" align="right" class="td_label"><b>Vendor Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px;">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Client ID:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Client Last Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>City:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Client First Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Phone #:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Phone #</b></td>
	 			       <td style="Width:5px"></td>
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 		      ...
	 		      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>DOB:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Service Code Description:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>MedicaiWaiver:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>Administrator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label"><b>CM:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Ins Exp Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>CaseMgrName:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>MIS#:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_10" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_10" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_11" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_11" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>EyeColor(Category):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_12" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_12" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Address:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_13" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_13" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>ResidenceType:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_14" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_14" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Vendor#:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_15" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_15" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Group:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_16" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_16" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
	 	          <tr>
                  ...
                  <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Age:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_17" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_17" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
                  <tr>
                  ...
                  <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Imaged:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	 				      <asp:textbox id="gic_consumer_col_label_18" runat="server" CssClass="inface" Width="180"></asp:textbox>
	 			      </td>
	 			      <td align="left" width="100" style="width: 100px; height: 26px;">
	 			          <asp:CheckBox ID="gic_consumer_col_disable_18" runat="server"  Text=""/>
	 			      </td>
	 			      <td colspan=4 style="WIDTH: 485px" width="485" Height="20"></td>
	 		      </tr>
	 	          <tr>
	 	          ...
	 	          <tr class="tr_common">
	 		          <td colspan=4 align="center" style="WIDTH: 485px" width="485" Height="20"><font color="#3366ff"><b>
	 		            <asp:Label ID="Col_CaseNotes" runat="server" Text="Case Notes"></asp:Label> List Column Label</b></font>
                      </td>
				      <td colspan=4 align="center" style="WIDTH: 485px" width="485" Height="20"><font color="#3366ff"><b></b></font></td>
                  </tr>
	 		      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Create Date/Time:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Day:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Template:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Minutes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Service Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Final Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Verify Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Miles:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Spent For Client:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Billing Hours:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
			      ...
			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" class="td_label" height="20"><b>Billing Minutes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="200" style="width: 200px">
	    ...
	    <div id="Disp_CUM" style="DISPLAY: none">
			...
			<div>  
	 	          <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">			        
	 		        <tr class="tr_common">
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>AKA Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class = "tr_common">  
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Maiden Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>UCI Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common"> 
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Date of Birth:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Gender:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Place of Birth:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Ethnicity:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Marital Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common"> 
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Height/Weight:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Hair Color:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">    
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Home Phone:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Eye Color:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Work Phone:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="width: 120px">
 	 			      ...
 	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Email:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
  	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Cell Phone:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="width: 120px">
 	 			      ...
 	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Fax No:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Street:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>City and State:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Zip/Mail Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
			        ...
			        <tr class="tr_common"> 
			          <td style="WIDTH: 150px;" align="right" width="150" class="td_label" height="20"><b>Physical County:</b></td>
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Legal County:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
			        ...
			        <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Attention:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Day Activity:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>School:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                      ...
                      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Residence Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Coordinator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                      ...
                      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Start Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px; height: 26px;" align="right" width="150" class="td_label"><b>Confidentiality:</b></td>
	 			      <td Width="5" style="height: 26px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px; height: 26px;">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Legal Status 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Legal Staus Date 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Legal Staus 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Legal Staus Date 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Conservator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Social Security Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Generic Agency 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>SSA Number/Suffix:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                      ...
                      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Vendor Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">  
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Institutional Deeming:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Generic Agency 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common"> 
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>EPSDT:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>MediCal Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>NF:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">  
	 			       <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Medicaid Waiver:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Excludability:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">  
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>IHSS:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Payee Indicator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Gross Income:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Family Size:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">     
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>% of Cost Participation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">      
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Frequency of Contact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Tickler Base Month:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Report Agency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Coordinator Agency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Coordinator Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Initial Inquiry Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Initial Interview Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Case Assign Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Eligibility Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr>
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last PCP/IFSP:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last CDER/ES:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last Quarterly 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last SA Review:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last Quarterly 3:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Consent Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>45 Day Waiver Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Quality of Life:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Medical Exam Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Psych Exam Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Comments 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Comments 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Comments 3:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr style="height:8px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Area/Group:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>MIS Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Supervisor:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Current Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Current Status Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Previous Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Previous Status Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Chart Storage Location 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Box Number 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Chart Storage Location 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Box Number 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Chart Storage Location 3:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Box Number 3:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Chart Storage Location 4:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Box Number 4:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr style="height:8px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Date of Call:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Last Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Screener:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>First Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px; height: 26px;" align="right" width="150" class="td_label"><b>Referral Source:</b></td>
	 			      <td Width="5" style="height: 26px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px; height: 26px;">
	 			      ...
	 			      <td style="WIDTH: 150px; height: 26px;" align="right" width="150" class="td_label"><b>Phone:</b></td>
	 			      <td Width="5" style="height: 26px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px; height: 26px;">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Relationship:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Other Referral Source:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Phone:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Agency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr style="height:8px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Group:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>First Name/Init:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Disabled:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Retired:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Deceased:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>SSN:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Custody:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Current Address:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Occupation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Address:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Work Address:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Zip/Mail Codes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr style="height:8px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Type of school placement</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>When first entered into special education?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			    ...
	 			    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>History of school placement</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Employment history</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>who obtained jobs</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Any terminations</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Department of Rehab</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Mental Health</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Child protection Service</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Foster care</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Adult protection Service</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	 			      ...
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>United Cerebral Palsy</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
                    ...
                    <tr class="tr_common">   
	 			      <td style="WIDTH: 150px" align="right" width="150" class="td_label" height="20"><b>Others</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="210" style="width: 210px">
	    ...
	    <div id="Disp_RESOURCE" style="DISPLAY: none">
			...
			<div>  
	 	          <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">	
	 		        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Vendor Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_vendor_number" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Vendor Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Service Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_service_code" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Sub Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_status" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Administrator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Phone:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_phone_1" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Address Line 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Admin/Emerg:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_phone_2" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Address Line 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Cell/Pager:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_cell_pager" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>City:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>State:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_address_state" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Fax:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Zip:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_address_zip" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Mail:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Email:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_email" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Tax ID Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Ratio:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_ratio" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Tax Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Level:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_level" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Rate:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			   ...
	 			   <tr>
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Unit:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Last Modified By:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_last_mod_by" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Last Modified Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Site Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_site_name" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>See Provider Relations:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      ...
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>QA Monitor:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      ...
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Staff Liaison:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Out of County Regional Center:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_out_of_county_rc" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Phone Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Physical County:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_county" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Regional Center:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Primary Language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_language_1" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Secondary Language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>License Number:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_license_number" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Vacancies:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Capacity:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_capacity" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Licensee:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Age Range:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_age_range" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>License Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Gender Preference:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_gender_pref" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>License Exp:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Ambulatory Status:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_amb_status" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Insurance Name:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Amb:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_ambulatory" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>NoAmb:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Insurance Exp:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Male:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_amb_m" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Female:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Medi-Cal:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_medi_cal" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>MW Billable Service:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Client Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_client_type" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Retardation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Dual Dx:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_dual_dx" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Profound:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Hearing Impaired:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_hearing" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Severe:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Behaviors:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_behaviors" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Bates Bill:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Moderate:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_mr_moderate" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Severe Behaviors:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Diabetes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_diabetes" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Mild:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Non-Compliance:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_noncomp" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>G-Tube:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Borderline:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_mr_border" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Tantrums:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Nurse on Staff:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_nurse" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Verbal Aggression:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Other:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_other" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Autism:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Physical Aggression:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_phys_aggr" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>C.P.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Property Destruction:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_prop_destr" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Biting:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Seizure Dx.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_seiz" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Self Abuse:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Controlled:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_seiz_cont" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Elopement:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Uncontrolled:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_seiz_uncont" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Sexually Acts Out:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>PICA:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_pica" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Smoking:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Toilet Trained:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_toilet" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Smearing:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Outdoors Only:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_smoke_out" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Incontinent:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Theft:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_profile_theft" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Indoors w/Restrictions:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Bedwetting:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Base Month:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_base_month" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Rate Effective:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Vendored Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_vendor_register_date" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>QA Evaluation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Unannounced Visit 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_unannounced_visit_1" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>QA Eval Exit:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Unannounced Visit 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_unannounced_visit_2" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Fiscal Evaluation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Monitor Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_monitor_date" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Rate Review:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>CCL/HCL Lic Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_ccl_hcl_lic_date" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>AR Checklist:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>AR Follow-up Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_ar_follow_up" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Sanction Date - Start:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>SIR Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_sir_date" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Sanction Date - End:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Technical Assist:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_technical_assistance" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>DDS Review:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Corrective Action:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_corrective_action_date" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Ad Hoc:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Delete Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Speciality 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_f_1" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Language 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Speciality 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_f_2" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Language 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>VSN Comment:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 1:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_comment_1" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 2:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 3:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_comment_3" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 4:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 5:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_r_comment_5" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments 6:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Svc Code Sub Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_ServiceList" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Vendor#:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Svc Code:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_pvsrcd" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Svc Code Description:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      ...
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Sub Code Description:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Comments:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 				      <asp:textbox id="l_psrcom" runat="server" CssClass="inface"  Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Unit Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Current Rate:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
			        ...
			        <tr class="tr_common">
			          <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>Beginning Date</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
	 			          <asp:textbox id="l_psrbeg" runat="server" CssClass="inface" Width="260px"></asp:textbox>
	 			      </td>
	 			      <td  style="WIDTH: 180px" width="180" align="right"  class="td_label" height="20"><b>End Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" style="width: 300px">
		...
		<div id="Disp_IDN" style="DISPLAY:none">
			...
			<div>  
	 	          <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">			        
	 		        <tr class="tr_common">	 			      
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			          <asp:textbox id="l_tx_type" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Entered By:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Template:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_template" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Minutes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Coordinator:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_uci" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Resource:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Description:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_id_notes" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Interdisciplinary Notes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Final:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_validated_date" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>TeleCom:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Miles:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_miles" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Travel-Related Exp. Hotel/Parking/Etc.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Spent for Client:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tx_SFC" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Misc:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	    ...
	    <div id="Disp_CDER" style="DISPLAY: none">
			...
			<div>     	  
			    <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">			        
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Report Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rptdte" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b></b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			      </td>
	 			    </tr>
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Height:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_hgt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Weight:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Date Weighed:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_dtewgt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Program:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Section:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_sctn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Unit:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			   ...
	 			   <tr>
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Franklin Factor:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_frkfac" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Development level:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>11. Level of Retardation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_lvlrtd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>12a:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>12b:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mr2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>13.Date of Last Evaluation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>14. Intelligence Quotient:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_iq" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>15. Intelligence Test:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>16. Adaptive Behavior Rating:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_adpvbh" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>17. Presence Of Cerebral Palsy:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>18a.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_othmd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>18b.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>19. Level of Motor Dysfunction:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_lvlmd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>20. Type of Motor Dysfunction:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>21. Location of Motor Dysfunction:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_locmd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>22. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
				      ...
				      <td colSpan="6" style="Height:5px"></td>
	 			      ...
	 			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>23. Autism:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_lvlaut" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>24a.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>24b.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_autsm2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>25. Determination Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>26. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_autimp" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>27a. Type of Seizure:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>27b. Seizure Frequency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_szfrq1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>27c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr>
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>28a. Type of Seizure:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_typsz2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>28b. Seizure Frequency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>28c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_szimp2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>29a. Type of Seizure:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>29b. Seizure Frequency:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_szfrq3" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>29c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>30a:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_eplp1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>30b.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>31. Medication:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_antcnv" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>32. Status Epilepticus:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
				      ...
				      <td colSpan="6" style="Height:5px"></td>
	 			      ...
	 			      <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>33a.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_othdd1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>33b.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>34a.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_oth1et" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>34b.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>35. Low birth weight or preterm labor with complications:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>36. Teenage pregnancy (17 years and younger):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr>
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>37. Maternal age 35 years or older at time of delivery:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf3" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>38. Accidents of near drowning:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>39. Accidents involving an automobile:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf5" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>40. Accidents involving other types of vehicles:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>41. Accidents of other types:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf7" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>42. Environmental toxins (pesticides,lead,etc.):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>43. Drug or alcohol abuse:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf9" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>44. Psychosocial (environmental) deprivation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>45. Family history of intellectual disability:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf11" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>46. Child abuse or neglect:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>47. Other cause(s):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rskf13" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>50a. Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>50b. Evaluation Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_dtmna1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>50c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr>
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51a. Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mntla2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51b. Evaluation Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mimpa2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52a. Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52b. Evaluation Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_dtmnb1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52c. Condition Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53a. Type:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mntlb2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53b. Evaluation Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53c. Condition Impacte:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr>
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>54a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>54b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>55a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>55b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>56a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc3" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>56b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>57a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc4" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>57b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>58a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc5" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>58b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>59a. Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_chrmc6" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>59b. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>60. Hearing Uncorrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_hrngun" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>61. Hearing Corrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>62. Vision Uncorrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_vsnun" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>63. Vision Corrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			     ...
	 			     <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>64. Anti-Psychotic:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_apsymn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>65. Anti-Depressant:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>66. Anti-Anxiety:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_aanxmn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>67. Sedative/Hypnotic:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>68. Stimulant:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_stmlnt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>69. Other:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>70. History Of Medication:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>71. Parkinsonism:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_parkin" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>72. Dystonia:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>73. Dyskinesia:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_dyskin" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>74. Akathisia:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>75. Paroxysmal Movements:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>76:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_sphc1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>77:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>78:</b></td>
	 			       <td style="Width:5px"></td>
                      ...
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>79:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>80:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_sphc5" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>81:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			   ...
	 			   <tr>
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>82:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_sphc7" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>83:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>84:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_sphc9" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>85:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>86. Does the client display maladaptive sexual behavior?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn1" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>87. Has the client engaged in any assaultive behaviors that could have resulted in serious bodily injury or death?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>88. Has the client attempted suicide in the past five years?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn3" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>89. Does the client habitually engage in theft?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>90. Has the client participated in acts of vandalism or acts of property destruction?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn5" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>91. Has the client been convicted of any substance abuse or alcohol related offenses?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>92. Does the client have a recent history of abusing drugs or alcohol?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn7" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>93. Does the client have a history of habitual lying?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>94. Does the client display behaviors which could result or have resulted in fire setting?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>95. Is the client currently on probation, parole, or commitment under Penal Code or W&&I Codes relating to criminal offense?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn10" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>96. Is the client currently on Diversion pursuant to Penal Code section 1001.20 et seq.?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>97. Is the client currently a person within the provisions of Welfare and Institutions code section 6500 et seq. (dangerous intellectual disability individual committed by the court)?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn12" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>98. Is the client currently under a Lanterman-Petris-Short  (mental health) conservatorship?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>99. Is the client currently a conservatee under the Probate Code (conserved because client is unable to make informed application and consent to treatment?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_spcn14" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>100. Is the client currently a dependent child of the Court (Welfare and Institutions Code section 300 et seq.)?:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>1. Rolling and sitting(<=7):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rolsit" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>2. Hand use:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>3. Arm use:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_armuse" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>4. Crawling and standing(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>5. Ambulation(<=2):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_amb" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>6. Climbing stairs:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>7. Wheelchair mobility(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_whlmob" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>8. Food preparation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>9. Bedmaking:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_bedmkg" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>10. Washing dishes:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>11. Household chores:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_hshld" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>12. Basic medical self-help:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>13. Self-medication:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_slfmed" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>14. Eating(<=5):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>15. Toileting(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tltng" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>16. Level of bladder control(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>17. Level of bowel control(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_lvlbwl" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>18. Personal hygiene(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>19. Bathing(<=2):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_bthng" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>20. Dressing(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>21. Movement/familiar setting:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mvmfml" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>22. Movement/unfamiliar setting:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>23. Transportation/community:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_trnscm" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>24. Money handling:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>25. Making purchases:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_mkprch" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>26. Ordering food/public:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>27. 1-TO-1 Interaction w/ peers:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_intrpr" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>28. 1-TO-1 Interaction w/ non-peers:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>29. Friendship formation:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_frndfr" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>30. Friendship maintenance:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>31. Partic./social activities:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_prtsoc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>32. Partic./group projects:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>33. Unaccept. soc. behavior(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_unscbh" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>34. Aggression(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>35. Freq/self-injur. behavior:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_frqsi" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>36. Severe/self-injur.behavior(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>37. Smear feces(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_smrfec" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>38. Destruction/property(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>39. Running/wandering away(<=5):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rnwnd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>40. Depressive-like behavior(<=2):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>41. Reaction to frustration(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rctfrs" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>42. Repetitive movements(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>43. Inappropriate undressing(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_inund" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>44. Hyperactivity(<=3):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>45. Temper tantrums(<=4):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_tmptnt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>46. Resistiveness(<=2):</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>47. ADJ. to changes in SOC. REL.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_adjsoc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>48. ADJ. to changes in PHYS. ENV.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>49. Auditory perception:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_audprc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>50. Visual perception:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51. ASSOC. time w/events && actions:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_timeas" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52. Number awareness:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53. Writing skills:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_wrtskl" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>54. Reading skills:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>55. Attention span:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_atnspn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>56. Safety awareness:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>57. Remembering instructions:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rmbins" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>58. Word usage:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>59. Expressive nonverbal comm.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_expnvc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>60. Receptive nonverbal comm.:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>61. Receptive language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rcplng" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>62. Expressive language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>63. Receptive sign language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_rcpslg" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>64. Expressive sign language:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>65. Expressive comm. w/aids:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_expcwa" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>66. Clarity of speech:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	    ...
	    <div id="Disp_POS" style="DISPLAY: none">	
			 ...
			 <div>     	  
			      <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">   
			           <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Cancel Date:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_cancel_date" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Reason for Cancellation:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Funding Level:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_funding_level" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Case Type:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>FCPP:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_assessment_date_yn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Assessment Date:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Authorization:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_auth" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Med.Waiver:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Inst. Deeming:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_inst_deeming" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Diagnosis:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Frankland Factor:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				                 <asp:textbox id="l_p_ff" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
                            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Developmental Level:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Vendor#:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Start Date:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_date_start" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Term Date:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Svc Code:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_vendor_svcc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Address:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Sub Code:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_vendor_subc" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Phone:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			           ...
			           <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b># of Units:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			           ...
			           <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>IPP#:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_ipp" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Approx. Monthly Cost:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			           ...
			           <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Rate:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_rate" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Old Monthly Cost:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px; height: 26px;" align="right" width="180" class="td_label"><b>Diff:</b></td>
	 			            <td Width="5" style="height: 26px"></td>
	 			            ...
	 			            <td style="WIDTH: 180px; height: 26px;" align="right" width="180" class="td_label"><b>Description of Service:</b></td>
	 			            <td Width="5" style="height: 26px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px; height: 26px;">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Justification of Service:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_just" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Medi-Cal:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Medicare:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_medicare" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>CCS:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>IHSS:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_ihss" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b># of hours:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>SSA:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_ssa" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>SSI:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>VA:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_va" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Payee:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Priv.Ins:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	 				            <asp:textbox id="l_p_priv_ins" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			            </td>
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Carrier:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>#:</b></td>
	 			            ...
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Other:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Entered By:</b></td>
	 			            ...
	 			            <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>ID:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
			          ...
			          <tr class="tr_common">
			               <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Comments:</b></td>
	 			             <td style="Width:5px"></td>
	 			            <td class="td_unline" align="left" width="300" style="width: 300px">
	    ...
	    <div id="Disp_CDER08" style="DISPLAY: none">   
			...
			<div> 
			     <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">	
			          <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="200" class="td_label" height="20"><b>1. Face to Face Date:</b></td>
	 			       <td style="Width:5px"></td>
                      ...
                      <td style="WIDTH: 180px" align="right" width="200" class="td_label" height="20"><b></b></td>
	 			       <td style="Width:5px"></td>
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>5. Height:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_hgt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>6. Weight:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>7. Date Weighed:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_dtewgt" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>8. Program:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			         ...
			         <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>9. Section:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_sctn" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>10. Unit:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>19. Severity of Motor Dysfunction:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 			    ...
	 			    <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>23a. Presence of Autistic Disorder:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_prsaut" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>23b. Presence of Other PDD:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>31. Consumer takes anticonvulsant medication:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>33. Other Disability:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51b. Eval Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_dtmna2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>51c. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52a. Type:</b></td>
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52b. Eval Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>52c. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53b. Eval Date:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_dtmnb2" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>53c. Impact:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>60. Level of Hearing Loss Uncorrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_hrngun" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>61. Level of Hearing Loss Corrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>62. Level of Vision Loss Uncorrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_vsnun" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>63. Level of Vision Loss Corrected:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>70. History of Prescribed Medication for Maladaptive Behavior:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the client display maladaptive sexual behavior?</b></td>
	 			       <td style="Width:5px"></td>
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Has the client engaged in any assaultive behaviors that could have resulted in serious bodily injury or death?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Has the client attempted suicide in the past five years?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			           <asp:TextBox ID="lc_spcn3" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the client habitually engage in theft?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Has the client participated in acts of vandalism or acts of propery destruction?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_spcn5" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Has the client been convicted of any substance abuse or alcohol related offenses?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the client have a recent history of abusing drugs or alcohol?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			           <asp:TextBox ID="lc_spcn7" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the client have a history of habitual lying?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the client display behaviors which could result or have resulted in fire setting?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_spcn9" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently on probation, parole, or commitment under Penal Code or W&&I Codes relating to criminal offense?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently on Diversion pursuant to Penal Code section 1001.20 et seq.?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_splgc2" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently a person within the provisions of Welfare and Institutions code section 6500 et seq. (dangerous intellectual disability individual committed by the court)?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently under a Lanterman-Petris-Short (mental health) conservatorship?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_splgc4" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently a conservatee under the Probate Code (conserved because client is unable to make informed application and consent to treatment)?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Is the client currently a dependent child of the Court (Welfare and Institutions Code section 300 et seq.)?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Using Hands</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_handus" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Walking</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Using a Wheelchair</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_whluse" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Taking Prescription Medication</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Eating</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_eating" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Toileting</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Bladder and Bowel Control</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_bbctrl" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Personal Care</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Dressing</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_drssng" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Safety Awareness</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Focusing on Tasks and Activities</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_focus" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Verbal Communication</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			       ...
			       <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Nonverbal Communication</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_novrbl" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Social Interaction</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Disruptive Social Behavior</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_disbhv" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Aggressive Social Behavior</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Self-Injurious Behavior</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_sevsi" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Destruction of Property</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			       ...
			       <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Running or Wandering Away</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_rnwnd" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Emotional Outbursts</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>What type of school does the consumer attend?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			           <asp:TextBox ID="lc_school" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>On a typical day, how much contact does the consumer have at school with students who do not have a disability?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			       ...
			       <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>On a typical day, how many people does the consumer interact with at school who speak the consumer¡¯s primary language (e.g., Spanish, English)?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			           <asp:TextBox ID="lc_scntsp" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>In what type of work or day program does the consumer participate most often?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>On a typical day, how many people does the consumer interact with at the day program and/or work site who do not have a disability? (Include both peers and staff)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_dcnndd" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>On a typical day, how many people does the consumer interact with at the day program and/or work site who speak the consumer¡¯s primary language?(Include both peers and staff)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>In a typical week, how many hours is the consumer paid for work? (Please estimate if the consumer is paid for productivity.)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_hrpdwk" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>In a typical week, how much does the consumer earn per hour of work? (Please estimate if the consumer is paid for productivity.)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>During the past 6 months, about how often did the consumer participate in community outings for personal errands, recreation, entertainment, or church?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_outing" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>How many friends does the consumer have?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Including the consumer, how many people with disabilities live in the household?(include both peers and staff)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_ddinhs" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>How many times has the consumer moved from one residence to another in the last 2 years?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>On a typical day, how many people who live at the consumer¡¯s household speak the consumer¡¯s primary language (e.g., Spanish, English, Cambodian)?(Include both peers and staff)</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			          <asp:TextBox ID="lc_spklng" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Did the consumer see a physician, nurse practitioner, or physician¡¯s assistant for medical care (including check-ups) during the past 12 months?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Did the consumer see a dentist for dental care(including check-ups) during the past 12 months?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
	 			         <asp:TextBox ID="lc_dscare" TextMode="MultiLine" Wrap="true" BorderStyle="Solid" runat="server"
                           Width="98%" Height="100"></asp:TextBox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Does the consumer currently have a medical and/or dental condition for which appropriate care is not being provided, although it should be?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px" valign="top">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you like living at _____?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_lklive" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you like the people who help you at _____?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			       ...
			       <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you want to keep living at _____?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_cnlive" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you like going to ______?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you like the people who help you at _____?</b></td>
	 			      ...
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you want to keep going to _____?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Who do you talk to when you are sad or unhappy?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_talkto" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you feel safe or afraid most of the time?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Are you happy or sad most of the time?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_hypsad" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Do you tell people what you want most the time?</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			       ...
			       <tr class="tr_common">	 			     
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Practical Independence:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_cdprin" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Personal /Social Skills:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Challenging Behaviors:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_cdchbh" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>WheelChair use:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			       ...
			       <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Non-verbal Communication:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_cdnonvb" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Integration:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">	 			     
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Well-Being:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="lc_cdwlbe" runat="server" CssClass="inface" Width="260"></asp:textbox>
	 			      </td>	 			    
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Untreated Medical Condition:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	    ...
	    <div id="Disp_BUTTON" style="DISPLAY: none">
			...
			<div>
	 			  <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0">			        
	 		        <tr class="tr_common">
	 			      <td style="WIDTH: 180px; height: 26px;" align="right" width="180" class="td_label"><b>Add:</b></td>
	 			      <td Width="5" style="height: 26px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px; height: 26px;">
	 				      <asp:textbox id="l_Add" runat="server" CssClass="inface" Width="260" MaxLength="12"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px; height: 26px;" align="right" width="180" class="td_label"><b>Delete:</b></td>
	 			      <td Width="5" style="height: 26px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px; height: 26px;">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Save:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_Save" runat="server" CssClass="inface" Width="260"  MaxLength="12"></asp:textbox>
	 			      </td>
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Print:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Help:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_Help" runat="server" CssClass="inface" Width="260"  MaxLength="12"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Search:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Renew:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_Renew" runat="server" CssClass="inface" Width="260"  MaxLength="12"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Image:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
			        ...
			        <tr class="tr_common">
	 			      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Message:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
	 				      <asp:textbox id="l_Message" runat="server" CssClass="inface" Width="260"  MaxLength="12"></asp:textbox>
	 			      </td>
                      <td style="WIDTH: 180px" align="right" width="180" class="td_label" height="20"><b>Map:</b></td>
	 			       <td style="Width:5px"></td>
	 			      <td class="td_unline" align="left" width="300" style="width: 300px">
