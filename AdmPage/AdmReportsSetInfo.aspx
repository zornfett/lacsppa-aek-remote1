<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdmReportsSetInfo.aspx.cs" Inherits="Virweb2.AdmPage.AdmReportsSetInfo" %>
	...
	<body onload="onloadsizechg(50);" onresize="onloadsizechg(50);">
            ...
            <tr valign="middle" style="height:30px; background-color: #EAF4FF">	
                <td align="left" valign="middle" width="25%">
                    ...
                    <input type="image" id="btnBack" runat="server" alt="Back" style="width: 25px;height:25px"  
                        ...
                        onclick="javascript:document.location.replace('AdmReportsSet.aspx');return false;" />  
                </td>
        ...
        <div id="maindiv" align="center" style="position:relative;WIDTH:100%;overflow:auto;height:450px">
            <table class="table_maindiv">		
				<tr class="tr_common">
				  <td style="WIDTH: 120px" align="right" class="td_label"><b>Reports Name:</b>
				  </td>
