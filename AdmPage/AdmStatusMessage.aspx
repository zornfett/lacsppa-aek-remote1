<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="AdmStatusMessage.aspx.cs" Inherits="Virweb2.AdmPage.AdmStatusMessage" validateRequest="false" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
       ...
       {              
	        window.location.replace("AdmStatusMessage.aspx?messageid="+messageid);
       }

       function doseltdbyflag(messageid)
       {
           switch(messageid)
           {
              case "1":                 
        ...
        <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="100%" >
            <tr valign="middle" style="height:30px; background-color: #EAF4FF">
                <td align="left" valign="middle" width="25%">
                    ...
                    <asp:ImageButton ID="btnAdd" runat="server" AlternateText="Save" Style="width:25px;height:25px"
                      ImageURL="../img/save.ico" ToolTip="Save"
                ...
                <td align="left" valign="middle" width="60%">        
                    <asp:Label ID="Info" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="blue">Messages</asp:Label>
                </td>
