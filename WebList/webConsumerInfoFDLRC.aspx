<%@ Page Language="c#" Inherits="Virweb2.WebList.webConsumerInfoFDLRC" Codebehind="webConsumerInfoFDLRC.aspx.cs" AutoEventWireup="True" %>
...
*/
    ...
    function doseltd(obj)
    {
	   ...
	   switch(obj.id)
	   {
	      case "TD_FS":
             ...
             document.ConsumerInfo.now_div_name.value="Consumer_TD_FS"; 
             enable_btnPrint();   
		     break;
		  case "TD_LF":    
			 Consumer_LF.style.display="";
			 document.ConsumerInfo.now_div_flag.value="2";
             document.ConsumerInfo.now_div_name.value="Consumer_TD_LF_1"; 
             enable_btnPrint();
          ...
          case "TD_SA":    
             ...
             document.ConsumerInfo.now_div_name.value="Consumer_TD_SA"; 
             enable_btnPrint(); 		    	
		     break;
          case "TD_EG":    
			 Consumer_EG.style.display="";
			 document.ConsumerInfo.now_div_flag.value="13"; 		    	
             document.ConsumerInfo.now_div_name.value="Consumer_TD_EG"; 
		     break;
          case "TD_PE":    
			 Consumer_PE.style.display="";
			 document.ConsumerInfo.now_div_flag.value="14"; 
             document.ConsumerInfo.now_div_name.value="Consumer_TD_PE"; 
             enable_btnPrint(); 		    	
		     break;
          case "TD_SD":    
			 Consumer_SD.style.display="";
			 document.ConsumerInfo.now_div_flag.value="15"; 
             document.ConsumerInfo.now_div_name.value="Consumer_TD_SD"; 
		     break;
	   }
    }    
    ...
    function save_click() {
       ...
       //if ((uci.length >= 7) && (uci.substring(0,1)!="0"))
       {
           ...
           if (document.getElementById("c_legal_status_1").value == "R")
           {
              ...
              if ((cur-vDob) >= 0)
              {
                 alert("Legal Status needs updating! Update failed.");
                 return false;                 
              }  
           }
        }
    ...
    function displayOtherBenefits()
    {
        ...
        switch(flag)
        {
            case "1":
                ...
                tab_Benefit3.style.display = "none";
                document.ConsumerInfo.BenefitsCnt.value = "2";
                break;
            case "2":
                tab_Benefit2.style.display = "";
                tab_Benefit3.style.display = "";
                document.ConsumerInfo.BenefitsCnt.value = "3";
    ...
    function addCoPayRecord()
    {
        NoCreateIDNotes();
        var consumer_key=document.ConsumerInfo.consumer_key.value.toString();
        popupDialog("webConsumerCoPayFDLRC.aspx?ClientID=" + consumer_key + "&type=add");
    }
    ...
    function payeezip3_click()
    {
        if ( document.getElementById("c_ocmh").value == "1")//Regional Center (tb_entry_name='1')
            document.ConsumerInfo.payeecode_changeflag.value = "1";
    }
    ...
    {
        window.location.replace("webConsumerInfoFDLRC.aspx");
    }
    ...
    function help_click()
    {
       var URLStr="../HelpFile/"+document.ConsumerInfo.now_div_name.value+".docx";
       winhref(URLStr, 'Help');
    }
    */
    //-->
    ...
    <script type="text/javascript">
     ...
     {
         var consumer_key="^"+document.ConsumerInfo.consumer_key.value.toString()+"^";
         popupDialogWithWindow("webConsumerMapInfo.aspx?select_consumer=" + consumer_key.toString());
     }
    </script>     
...
<body id="body" runat="server" >  
    ...
    <input type="hidden" name="now_div_LF_name" id="now_div_LF_name" value="" runat="server" />
    <input type="hidden" name="now_div_AF_name" id="now_div_AF_name" value="" runat="server" />
    ...
    <input type="hidden" name="consumer_dty" id="consumer_dty" value="19" runat="server" />
                    ...
                    <table class="table_common" cellspacing="0" cellpadding="0">
                        <tr class="tr_common">
                            <td align="center" colspan="2">
                                <font color="#3366ff"><b>Financial Info</b></font>
                            </td>
                        </tr>
                        <tr style="height:5px;">
                            <td>
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_common" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td>
                                            <table id="tab_Benefit3" style="display:none" class="table_common" cellspacing="0" cellpadding="0">
                                                <tr class="tr_common">
                                                    <td style="width: 210px" align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_ccs" runat="server" Text="Cash Benefit:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                                    <td align="left" width="300">
                                                        <asp:DropDownList ID="c_ccs" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                              Width="305" OnChange="DataChanged()" >
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="tr_common">
                                                    <td style="width: 210px" align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_ghpp" runat="server" Text="Amount:"></asp:Label></b>
                                                    </td>
                                                    <td  style="width: 5px">
                                                    </td>
                                                    <td class="td_unline" align="left" width="300">
                                                        <asp:TextBox ID="c_ghpp" runat="server" CssClass="inface" MaxLength="50" Width="300"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="height:5px;">
                                                    <td>
                                                ...
                                                <tr class="tr_common">
                                                    <td align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_wpcsHrs" runat="server" Text="Frequency:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                                    <td align="left" width="300">
                                                        <asp:DropDownList ID="c_wpcsHrs" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                                  Width="305" OnChange="DataChanged()" >
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr class="tr_common">
                                                    <td style="width: 210px" align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_shareofcost" runat="server" Text="Representative Payee:"></asp:Label></b>
                                                    </td>
                                                    <td  style="width: 5px">
                                                    </td>
                                                    <td class="td_unline" align="left" width="300">
                                                        <asp:TextBox ID="c_shareofcost" runat="server" CssClass="inface" MaxLength="50" Width="300"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                <tr style="height:5px;">
                                                    <td>
                                                ...
                                                <tr class="tr_common">
                                                    <td style="width: 210px" align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_ocmh" runat="server" Text="Payee Code:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                                    <td align="left" width="300">
                                                        <asp:DropDownList ID="c_ocmh" 
                                                              runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                              Width="305" OnClick="DataChanged();payeezip3_click();" >
                                                        </asp:DropDownList>
                                                    </td>
                                                </tr>
                                            </table>
                                    ...
                                    <tr class="tr_common">
                                        <td>
                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                <tr class="tr_common">
                                                    <td align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_generic_agency_1" runat="server" Text="Other Income:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                        ...
                                        <td>
                                            <table id="tab_agency2" style="display:none" class="table_common" cellspacing="0" cellpadding="0">
                                                <tr class="tr_common">
                                                    <td align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_generic_agency_2" runat="server" Text="Other Income:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                                    <td align="left" width="300">
                                    ...
                                    <tr>
                                        <td>
                                            <table id="tab_agency3" style="display:none" class="table_common" cellspacing="0" cellpadding="0">
                                                <tr class="tr_common">
                                                    <td align="right" width="210" class="td_label" >
                                                        <b><asp:Label ID="l_c_generic_agency_3" runat="server" Text="Other Income:"></asp:Label></b>
                                                    </td>
                                                    <td width="5" >
                                                    </td>
                                                    <td align="left" width="300">
                    ...
                    <table class="table_common" cellspacing="0" cellpadding="0">
                            ...
                            <td align="left" style="width:48%">
                                ...
                                <tr class="tr_common">
                                    ...
                                    <td class="td_unline" align="left" style="width: 260px">
                                            <asp:TextBox ID="c_bic_number" runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                    </td>
                                    <td valign="top" align="left">
                        ...
                        <tr class="tr_common">
                            ...
                            <td align="left" style="width:48%">
                                ...
                                <tr class="tr_common">
                                    <td style="width: 210px" align="right" width="210" class="td_label" >
                                        <b><asp:Label ID="Label129" runat="server" Text="Company/Provider:"></asp:Label></b>
                                    </td>
                                    <td  style="width: 5px">
                                    </td>
                                    <td class="td_unline" align="left" style="width: 300px">
                                            <asp:TextBox ID="medical_provider" runat="server" CssClass="inface" MaxLength="50" Width="300"></asp:TextBox>
                                    </td>
                                    <td>&nbsp;</td>
                                    <td style="width:auto"></td>
                                </tr>
                            ...
                            <td align="left" style="width:48%">
                                <table class="table_common" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td width="5"></td>
                                        <td class="td_unline" align="left" width="300">
                                            <asp:TextBox ID="primary_othername" runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr style="height:5px">
                                        <td colspan="3">
                                           ...
                                           <table class="table_common" cellspacing="0" cellpadding="0">
                                             <tr class="tr_common">
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label121" runat="server" Text="Group #:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="primary_othergroup" runat="server" CssClass="inface" MaxLength="20"></asp:TextBox>
                                                </td>
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label122" runat="server" Text="Member ID:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="primary_othermember" runat="server" CssClass="inface" MaxLength="20"></asp:TextBox>
                                                </td>
                                             </tr>
                                             <tr style="height:5px">
                                                <td colspan="6">
                                             ...
                                             <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="primary_otherperiodfrom" runat="server" CssClass="inface" 
                                                ...
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="primary_otherperiodto" runat="server" CssClass="inface"
                                                           onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);"></asp:TextBox>
                                                </td>
                                             </tr>
                                           </table>
                            ...
                            <td align="left" style="width:48%" >
                                <table class="table_common" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td height="20" width="5"></td>
                                        <td class="td_unline" align="left" width="300">
                                            <asp:TextBox ID="secondary_othername" runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                        </td>
                                    </tr>
                                     <tr style="height:5px">
                                        <td colspan="3">
                                    ...
                                    <tr class="tr_common">
                                        <td colspan="3">
                                           <table class="table_common" cellspacing="0" cellpadding="0">
                                             <tr class="tr_common">
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label125" runat="server" Text="Group #:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="secondary_othergroup" runat="server" CssClass="inface" MaxLength="20"></asp:TextBox>
                                                </td>
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label126" runat="server" Text="Member ID:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="secondary_othermember" runat="server" CssClass="inface" MaxLength="20"></asp:TextBox>
                                                </td>
                                             </tr>
                                             <tr style="height:5px">
                                                <td colspan="6">
                                             ...
                                             <tr class="tr_common">
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label127" runat="server" Text="Benefits Period:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="secondary_otherperiodfrom" runat="server" CssClass="inface" 
                                                           onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);"></asp:TextBox>
                                                </td>
                                                <td style="width: 100px" width="100px" class="td_label" >
                                                   <b><asp:Label ID="Label128" runat="server" Text="To:"></asp:Label></b>
                                                </td>					   						    
                                                <td width="5"></td>
                                                <td class="td_unline" align="left" width="120">
                                                   <asp:TextBox ID="secondary_otherperiodto" runat="server" CssClass="inface"
                                                           onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);"></asp:TextBox>
                                                </td>
                                             </tr>
                                           </table>
                    ...
                    <table class="table_common" cellspacing="0" cellpadding="0">
                        ...
                        <tr class="tr_common">
                            <td align="center" colspan="2">
                                ...
                                <asp:BoundColumn DataField="insurancename" HeaderText="Insurance Name"></asp:BoundColumn>
						        <asp:BoundColumn DataField="cpdate" HeaderText="Input Date" DataFormatString="{0:MM/dd/yyyy}"></asp:BoundColumn>
						        <asp:TemplateColumn HeaderText="Edit">
							        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle"></HeaderStyle>
							        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
							        <ItemTemplate>
	                                        ...
	                                        <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0" style="width: 98%">
                                                ...
                                                <tr class="tr_common">
                                                    ...
                                                    <td style="width: 120px" class="td_unline"  >
                                                        <asp:TextBox ID="cpdate" Text='<%# DataBinder.Eval(Container.DataItem, "CpDate", "{0:d}") %>' runat="server" CssClass="inface" width="80px"></asp:TextBox>
                                                    </td>
                                                    <td  style="width: 20px"></td>
                                                </tr>
                                                <tr style="height: 5px;">
                                                    ...
                                                    <td colspan="4">
                                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                                           <tr class="tr_common">  
                                                             ...
                                                             <td width="5"></td>
                                                             <td class="td_unline" align="left" width="120">
                                                                <asp:TextBox ID="startdate" Text='<%# DataBinder.Eval(Container.DataItem, "startdate", "{0:d}") %>' runat="server" CssClass="inface"></asp:TextBox>
                                                             </td>
                                                             <td style="width: 100px" width="100px" class="td_label" >
                                                                <b><asp:Label ID="Label124" runat="server" Text="To"></asp:Label></b>
                                                             </td>					   						    
                                                             <td width="5"></td>
                                                             <td class="td_unline" align="left" width="120">
                                                                <asp:TextBox ID="enddate" Text='<%# DataBinder.Eval(Container.DataItem, "enddate", "{0:d}") %>' runat="server" CssClass="inface"></asp:TextBox>
                                                             </td>
							...
							<ItemTemplate>
                                <table class="table_inside" cellspacing="0" cellpadding="0">
                                   ...
                                   <tr style="height: 5px">
                                    ...
                                    <tr class="tr_common">
                                       <td colspan="4" align="left" class="infaceTextNoPad">
                                    ...
                                    <tr class="tr_common">
                                       ...
                                       <td colspan=2 align="left" width="600" class="td_unline">
                ...
                <div id="Consumer_CT" style="display: none">
                    <table class="table_common" cellspacing="0" cellpadding="0">
                       ...
                       <tr class="tr_common">
                        ...
                        <asp:BoundColumn DataField="GroupName" HeaderText="Group" Visible="False" SortExpression="GroupName">
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                        </asp:BoundColumn>
                               ...
                               <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="95%" >
	                              <tr class="tr_common">
	                                <td style="width: 150px" align="right" width="150" class="td_label" >
                                       <b><asp:Label ID="Label44" runat="server" Text="Service Delivery Type:"></asp:Label></b>
                                    </td>
                                    <td width="5" >
                                    </td>
                                    <td align="left" width="300">
                            ...
                            <td>
                               <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="95%" >
	                              <tr style="height: 30px;" valign="middle">
	                                ...
	                                <td align="center">
			                           <asp:label id="Label45" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Green" Height="18px">Self Determination List</asp:label>
			                        </td>
		                          </tr>
		                       </table>
		                    </td>
