<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="webMedicalMedication.aspx.cs"
    Inherits="Virweb2.WebList.webMedicalMedication" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_click() {
            var consumer_key = document.MedicalMC.consumer_key.value.toString();
            var UserAct = document.MedicalMC.UserAct.value.toString();
            var entry_date = document.MedicalMC.entry_date.value.toString();
            var url = "PrintMedicalMedication.aspx?consumer_key=" + consumer_key + "&entry_date=" + entry_date + "&UserAct=" + UserAct;
            winhref(url, "PrintMedicalMedication");
        }
            ...
            <tr style="height: 30px;" align="left" valign="middle">
                ...
                <td>
                    ...
                    <input type="button" id="btnPrint" value="Print" style="width: 60px;" class="buttonbluestyle"
                        onclick="javascript:print_click();return false;" runat="server" />
                ...
                <td>
                    <table class="table_inside" cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr class="tr_common">
                            ...
                            <td style="width: 250px"  width="250" class="td_unline" >
                                <asp:DropDownList ID="prescribedby" onchange="getMedicationChanges('prescribedby');"
                                    runat="server" DataValueField="name" DataTextField="name"  CssClass="infaceDrop"
                                    OnClick="DataChanged()">
                                </asp:DropDownList>
                            </td>
                            <td width="10" >
