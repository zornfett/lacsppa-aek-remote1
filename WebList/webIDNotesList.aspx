<%@ Page Language="C#" Inherits="Virweb2.WebList.webIDNotesListSCLARC" Codebehind="webIDNotesList.aspx.cs" AutoEventWireup="True" %>
...
*/
        ...
        function print_click()
        {
           ...
           var url = "PrintWebIDNotesList.aspx?c_uci=" + c_uci + "&userid=" + userid + "&validated=" + validated +
           "&groupid=" + groupid + "&viewown=" + viewown + "&monthrange=" + monthrange + "&UserAct=" + UserAct + "&orderby=" + orderby;
           winhref(url, 'PrintWebIDNotesList');
        }

        function Add_click()
        {
           document.location.replace("webIDNotesInfo.aspx?type=add&validated="+document.IDNotesList.validated.value);
        }
