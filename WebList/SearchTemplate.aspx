<%@ Page Language="C#" AutoEventWireup="true" Inherits="Virweb2.WebList.SearchTemplate" Codebehind="SearchTemplate.aspx.cs" %>
...
<body>
    <form id="SearchTemplateForm" runat="server">
        ...
        <tr><td valign="top" align="center">
		    <asp:label id="TitleTemplate" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue" Height="18px">TEMPLATES LIST</asp:label>
        </td></tr>
        <tr><td></td></tr>
			...
			<asp:datagrid id="dg_templates" runat="server" CssClass="grd_body"
				...
				<Columns>
                	<asp:TemplateColumn HeaderText="PASTE">
						...
						<ItemTemplate>
							<asp:ImageButton CommandName="Edit" Runat="server" ID="imgPaste" Width="15px" Height="15px" ImageUrl="../img/edit.gif"
