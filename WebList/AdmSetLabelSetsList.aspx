<%@ Page Language="C#" Inherits="Virweb2.WebList.AdmSetLabelSetsList" Codebehind="AdmSetLabelSetsList.aspx.cs" AutoEventWireup="True" %>
	           ...
	           <tr style="height: 30px;background-color: #EAF4FF" valign="middle" >
	             <td align="left" valign="middle" width="25%">
                    ...
                    <input type="image" id="btnAdd" runat="server" alt="New" style="width: 25px;height:25px"
                       ...
                       onclick="javascript:document.location.replace('../weblist/AdmSetLabelSetsInfo.aspx');return false;" />
                    &nbsp;
