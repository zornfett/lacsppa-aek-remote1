<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.WebList.webTicklerResSCLARCBaseMon" Codebehind="webTicklerResSCLARCBaseMon.aspx.cs" %>
...
<head>
		...
		<title>:::Update Vendor Tickler Info:::...</title>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
            <tr style="height:30px">
                <td colspan="2" align="center" style="font-family: Arial"><h3>
                   <asp:Label ID="Title" runat="server">Vendor Tickler Information</asp:Label> 
                </h3></td>
            </tr>
            <tr style="height:30px">
                <td colspan="2"></td>
