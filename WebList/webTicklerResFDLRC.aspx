<%@ Page Language="C#" Inherits="Virweb2.WebList.webTicklerResFDLRC" Codebehind="webTicklerResFDLRC.aspx.cs" AutoEventWireup="True" %>
	...
	<script type="text/javascript">
        ...
        function checkfillin(event, control)
        {
            ...
            if (curpos>0)
            {
               ...
               {
                  alert("Please enter the date for Visit Date/Response before enter the Complete Date");
                  return false;
               }
            }
    ...
    <div id="maindiv" align="center" style="position:relative;WIDTH:100%;height:450px;  overflow: auto ">
       ...
       <table class="table_common" cellspacing="0" cellpadding="0">
		...
		<asp:datagrid id="dg_tickler" runat="server" AllowPaging="false" CssClass="grd_bodyborder"
		  ...
		  <asp:BoundColumn DataField="r_kea_monitor" HeaderText="QA Monitor"  Visible="false"></asp:BoundColumn>
