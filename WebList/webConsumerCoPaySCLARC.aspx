<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webConsumerCoPaySCLARC.aspx.cs" Inherits="Virweb2.WebList.webConsumerCoPaySCLARC" %>
		...
		<table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="98%" >
	      <tr style="height: 50px;" align="center" valign="bottom">
	        <td colspan=2>
              ...
              Under 400% Federal Poverty Level</asp:label> 
	        </td>
	      </tr>
    ...
    <div align="center" valign="top" style="position:relative;WIDTH:100%; overflow: auto " >
	    <table class="table_common" cellSpacing="0" cellPadding="0" align="center" border="0" style="width: 98%">
                ...
                <td colspan="4">
                 <table class="table_common" cellspacing="0" cellpadding="0">
                  ...
                  <td class="td_unline" align="left" width="400">
                    <asp:TextBox ID="Insurancename" runat="server" CssClass="inface" MaxLength="100"></asp:TextBox>
                  </td>
            ...
            <tr class="tr_common">
                ...
                <td align="left" width="400">
                    <asp:DropDownList ID="Vendor" runat="server" DataValueField="r_resource_id"
                        DataTextField="ResourceName" Width="400" OnClick="DataChanged()">
                    </asp:DropDownList>
                </td>
                <td style="width: 40px"></td>
            </tr>
            ...
            <tr class="tr_common">
                ...
                <td align="left" width="400">
                    <asp:DropDownList ID="Exemption" runat="server" Width="105" DataValueField="tb_entry_name"
                        DataTextField="tb_entry_text" OnClick="DataChanged()">
                    </asp:DropDownList>
                </td>
                <td  style="width: 40px"></td>
