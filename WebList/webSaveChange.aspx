<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webSaveChange.aspx.cs" Inherits="Virweb2.WebList.webSaveChange" %>
    ...
    <form id="form1" runat="server">    
        <center>
         ...
         <tr style=" height:30px">          
            ...
            <td><asp:label id="Label1" runat="server" Font-Size="10pt" Font-Bold="True" ForeColor="Black">Do you want to save the changes made?</asp:label></td>
         </tr>
         <tr style="height:10px;">
            <td colspan="2"></td>
         </tr>
