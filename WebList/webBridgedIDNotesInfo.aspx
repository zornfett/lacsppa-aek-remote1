<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webBridgedIDNotesInfo.aspx.cs" Inherits="Virweb2.WebList.webBridgedIDNotesInfo" %>
    ...
    <script type="text/javascript">
        ...
        function List_click()
        {
            if (Confirm_Page())
            {
                ...
                document.location.replace("webBridgedIDNotesList.aspx?searchUCI=" + searchUCI); 
            }
        }
        ...
        { 
          ...
          winhref("PrintIDNotesInfo.aspx?tx_uci=" + tx_uci + "&tx_date=" + tx_date + "&txty_type=" + txty_type + "&fromType=Bridged" + "&UserAct=" + UserAct, "PrintIDNotesInfo");        
        }
