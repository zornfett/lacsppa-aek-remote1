<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormAnnualContactInfo.aspx.cs"
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        ...
        function back_click() {
            if (Confirm_Page())
                document.location.replace('FormAnnualContactList.aspx');
        }
                ...
                <td valign="top" align="center" width="100%" height="100%">
                    <div id="Review">
                        <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%;
                                ...
                                <td>
                                    <table class="table_inside" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td class="td_unline" style="width: 200px">
                                                <asp:Label ID="c_review_pcp_ifsp_date" runat="server" CssClass="infaceText"></asp:Label>
                                            </td>
                                            <td style="width: 20">
                                            </td>
                                            <td class="td_label" style="width: 100px">
                                            ...
                                            <td class="td_unline" width="100">
                                                <asp:DropDownList ID="c_medicaid_waiver" runat="server" Enabled="false" CssClass="infaceDrop"
                                                    OnClick="DataChanged()">
                                        ...
                                        <tr class="tr_common">
                                            <td colspan="11" style="width: 180px" class="td_label">
                            ...
                            <tr class="tr_common">
                                <td class="td_label">
                                    <asp:Label ID="Label7" Font-Bold="True" runat="server" Text="A. Physical and Social Environment:"></asp:Label>
                                </td>
                            </tr>
                            <tr style="height: 5px;">
                                <td>
                            ...
                            <tr class="tr_common">
                                <td class="td_label">
                                    <asp:Label ID="Label16" Font-Bold="True" runat="server" Text="Out of Home Living:"></asp:Label>
                                </td>
                            </tr>
                            <tr style="height: 5px;">
                                <td>
