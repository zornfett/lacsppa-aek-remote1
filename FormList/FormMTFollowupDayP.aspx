<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTFollowupDayP.aspx.cs" Inherits="Virweb2.FormList.FormMTFollowupDayP" %>
    ...
    <!--
        function print_click() {
            ...
            if (document.MTInfo.link_mtid.value == document.MTInfo.main_mtid.value)
                isfollowup="0";   
            winhref("PrintFormMTFollowupDayP.aspx?MTID="+entrykey+"&IsFollowup="+isfollowup,"PrintFormMTFollowupDayP");         
        }
        ...
        function AddCitation(ItemNo,Qno)
        {
            document.MTInfo.SelItemNo.value = ItemNo; 
            var entrykey=document.MTInfo.entrykey.value.toString();
            popupDialog("FormMTCitation.aspx?MTID=" + entrykey + "&FormType=Follow Up&Qno=" + Qno + "&type=add");
        ...
        function EditCitation(ItemNo,CitationID,Qno,bedit)
        {
            document.MTInfo.SelItemNo.value = ItemNo;
            if (bedit==1)
               popupDialog("FormMTCitation.aspx?CitationID=" + CitationID + "&Qno=" + Qno + "&type=edit");
            else  
               popupDialog("FormMTCitation.aspx?CitationID=" + CitationID + "&Qno=" + Qno );
