<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTSelFormTypeFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormMTSelFormTypeFDLRC" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
		...
		<!--
            function newform(tid, rid) {
                var strURL = "";
                if (tid == 1) {
                    strURL = "FormMTUnannAnnualFDLRC.aspx?rid=" + rid + "&type=add";
                }
                else if (tid == 2) {
                    ...
                    strURL = "FormMTUnannVisitFDLRC.aspx?rid=" + rid + "&type=add";
                }
                //else if (tid == 5) {
                //    strURL = "FormMTComplianceFDLRC.aspx?rid=" + rid + "&type=add";
                //}
                else if (tid == 6) {
                    strURL = "FormMTSLSFDLRC.aspx?rid=" + rid + "&type=add";
                }
                else if (tid == 7) {
                    strURL = "FormMTILSFDLRC.aspx?rid=" + rid + "&type=add";
                }
