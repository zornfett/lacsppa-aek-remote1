...
namespace Virweb2.FormList.Report {
    ...
    public class PrintFormIFSPInfoFDLRC : ReportClass {
        
        public PrintFormIFSPInfoFDLRC() {
        }
        
        public override string ResourceName {
            get {
                return "PrintFormIFSPInfoFDLRC.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Virweb2.FormList.Report.PrintFormIFSPInfoFDLRC.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPrintFormIFSPInfoFDLRC : Component, ICachedReport {
        
        public CachedPrintFormIFSPInfoFDLRC() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PrintFormIFSPInfoFDLRC rpt = new PrintFormIFSPInfoFDLRC();
            rpt.Site = this.Site;
            return rpt;
        }
