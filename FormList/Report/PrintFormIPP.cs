...
namespace Virweb2.FormList.Report {
    ...
    public class PrintFormIPP : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Virweb2.FormList.Report.PrintFormIPP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPrintFormIPP : Component, ICachedReport {
        
        public CachedPrintFormIPP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PrintFormIPP rpt = new PrintFormIPP();
            rpt.Site = this.Site;
            return rpt;
        }
