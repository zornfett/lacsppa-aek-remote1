<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormConsumerLocInfo.aspx.cs" Inherits="Virweb2.FormList.FormConsumerLocInfo" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        function print_click() {
            ...
            var url = "PrintFormConsumerLocInfo.aspx?c_key=" + c_key + "&Createdate=" + CreateDate + "&type=0";
        ...
        function save_click() {
            ...
            if ((!document.LocInfo.Consmr.checked) && (!document.LocInfo.ConsumerMailing.checked) &&
                (!document.LocInfo.Bus.checked) && (!document.LocInfo.Voucher.checked) && (!document.LocInfo.Other.checked))
            {
               alert("Please check at least one selection from Consumer/Consumer Mailing/Bus Pass/Voucher/Other");
               return false;
            }
        ...
        /*
        function displayChangeInfo_Tab()
        {
            document.getElementById("ChangeInfo_Tab").style.display="";
        }
        */
       ...
       function ResetResource() 
       {
           ...
           document.getElementById('<%= this.r_vendor_number.ClientID %>').innerHTML = "";
           document.getElementById('<%= this.r_service_code.ClientID %>').innerHTML = "";
           document.getElementById('<%= this.r_sub_code.ClientID %>').innerHTML = "";
           document.LocInfo.hdn_r_vendor_number.value = "";
           document.LocInfo.hdn_r_service_code.value = "";
           document.LocInfo.hdn_r_sub_code.value = "";
           document.LocInfo.ServiceDesc.value = "";
           document.LocInfo.FacilityName.value = "";
           document.LocInfo.FacilityAddress.value = "";
           document.LocInfo.FacilityAddress_2.value = "";
           document.LocInfo.FacilityCity.value = "";
           document.LocInfo.FacilityState.value = "";
           document.LocInfo.FacilityZip.value = "";
           document.LocInfo.FacilityPhone_1.value = "";
           document.LocInfo.FacilityPhone_2.value = "";
           document.LocInfo.FacilityPhone_3.value = ""; 
...
<body  runat="server" id="body">
    ...
    <input type="hidden" name="hdn_r_vendor_number" id="hdn_r_vendor_number" value="" runat="server" />
    <input type="hidden" name="hdn_r_service_code" id="hdn_r_service_code" value="" runat="server" />
    <input type="hidden" name="hdn_r_sub_code" id="hdn_r_sub_code" value="" runat="server" />
                ...
                <td valign="top" align="center" width="100%" height="100%">
                    <div id="Tab1">
                        <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 97%">
                                ...
                                <td>
                                    <table class="table_inside" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                            ...
                                            <td colspan="3" class="td_unline" style="width: 310px">
                                                <asp:TextBox ID="FacilityName" placeholder="Name" runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                            </td>
                                            <td style="width: 5px">
                                            </td>
                                            <td class="td_label" style="width: 150px">
                                                <asp:Label ID="Label32" runat="server" Font-Bold="True" Text="Service Desc:"></asp:Label>
                                            </td>
                                            <td width="10">
                                            </td>
                                            <td colspan="3" class="td_unline" style="width: 305px">
                                                <asp:TextBox ID="ServiceDesc" runat="server" CssClass="inface" MaxLength="250"></asp:TextBox>
                                            </td>
                                            <td style="width: 5px">
                                            </td>
                                            <td style="width: 120px">
                                                <input type="button" value="Select" style="width: 80px" id="btnResource" runat="server" onclick="javascript:popupDialogWide('SearchResource.aspx?page=FlowChart');" />
                                            </td>
                                        </tr>
                                        <tr style="height: 5px">
                                            <td colspan="3">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td style="width: 150px;">
                                                <asp:Label ID="r_vendor_number" runat="server" CssClass="infaceText"></asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td style="width: 150px;" class="td_label">
                                            ...
                                            <td style="width: 150px;">
                                                <asp:Label ID="r_service_code" runat="server" CssClass="infaceText"></asp:Label>
                                            </td>
                                            <td style="width: 10px">
                                            </td>
                                            <td style="width: 150px;" class="td_label">
                                            ...
                                            <td style="width: 150px;">
                                                <asp:Label ID="r_sub_code" runat="server"  CssClass="infaceText"></asp:Label>
                                            </td>
                                            <td style="width: 5px;">
                                            <td style="width: 120px">
                                    ...
                                    <table class="table_inside" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                            <td width="100" class="td_label">
						                      <b><asp:Checkbox ID="Consmr" runat="server" Text="" Checked=true Enabled=false></asp:Checkbox>Consumer</b>
                                            </td>
                                        ...
                                        <tr class="tr_common">
                                            <td width="100" class="td_unline">
						                       <asp:Label ID="Consmr_date" runat="server" CssClass="infaceText" Visible="false"></asp:Label>
                                            </td>
                            ...
                            <tr>
                                <td>
                                    <table class="table_inside" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                            <td class="td_label"  style="width: 150px">
                                               <b><asp:Label ID="l_residencetype" runat="server" Text="Residence Type:"></asp:Label></b>
                                            </td>
                                            <td width="5" >
                                            </td>
                                            <td width="450">
                                               <asp:DropDownList ID="ResidenceType" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_textID"
                            ...
                            <tr>
                                <td>
                                    <table class="table_inside" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                            <td class="td_label" style="width: 150px">
                                                <b><asp:Label ID="lb_changedate" runat="server" Text="Moved In:"></asp:Label></b>
                                            </td>
                                            <td  width="5">
                                            </td>
                                            <td class="td_unline" style="width: 150px;">
                                                <asp:TextBox ID="ChangeDate" runat="server"  CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                                            ...
                                            <td class="td_label" style="width: 50px">
                                                <b><asp:Label ID="Label9" runat="server" Text="Initial:"></asp:Label></b>
                                            </td>
                                            <td  width="5">
                                            </td>
                                            <td class="td_unline" style="width: 150px">
                                                <asp:TextBox ID="Initial" runat="server" CssClass="inface"  MaxLength="2"></asp:TextBox>
                                            </td>
                                            <td>&nbsp;</td>
                                            <td style="width:auto"></td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    <table id="ChangeInfo_Tab" runat="server" class="table_inside" cellspacing="0" cellpadding="0" border="0" style="width: 100%;">
                                        <tr class="tr_common">
                                            <td class="td_label" style="width: 150px">
                                                <b><asp:Label ID="Label11" runat="server" Text="Moved Out:"></asp:Label></b>
                                            </td>
                                            <td  width="5">
                                            </td>
                                            <td class="td_unline" style="width: 150px;">
                                                <asp:TextBox ID="DischargeDate" runat="server" CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                                                    onfocus="showcalendar(event, this);">
                                                </asp:TextBox>
                                            </td>
                                            <td style="width: 30px">
                                            ...
                                            <td class="td_label" style="width: 150px">
                                                <b><asp:Label ID="lb_reason" runat="server"  Text="Reason for Leaving:"></asp:Label></b>
                                            </td>
                                            <td  width="5">
                                            </td>
                                            <td class="td_unline" style="width: 200px">
                                                <asp:DropDownList ID="Reason"  runat="server" DataTextField="tb_entry_text" DataValueField="tb_entry_name"
                                                    CssClass="infaceDrop" OnClick="DataChanged()">
                                                </asp:DropDownList>
                                            </td>
                                            <td>&nbsp;</td>
