<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormESRTurning3List.aspx.cs" Inherits="Virweb2.FormList.FormESRTurning3List" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
    <base target="_self" />
    <title>:::ES TURNING 3 LIST:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        function RefreshMyData()    
        {
          ...
          window.document.Turning3List.submit(); 
          window.focus();   
        }
        ...
        function doseltd(obj) {
            ...
            switch (obj.id) {
                case "ERT_MR":
                    ...
                    document.Turning3List.now_div_flag.value = "1";
                    break;
                case "ERT_AR":
                    Ert_AR.style.display = "";
                    document.Turning3List.now_div_flag.value = "3";
                    break;
            }
        }
...
<body onload="onloadsizechg(110);" onresize="onloadsizechg(110);">
    ...
    <form id="Turning3List" method="post" runat="server">
        ...
        <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%">
            ...
            <tr style="height: 30px;" valign="middle">
                ...
                <td align="left" width="600px">
			           <asp:label id="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Green" Height="18px">ES TURNING 3 LIST</asp:label>
			    </td>
            </tr>
            <tr style="height: 5px">
                <td colspan=2>
        ...
        <div id="Ert_MR" align="center" style="position: relative; width: 100%; height: 100%;
            ...
            <asp:datagrid ID="dg_FormMR" runat="server" AllowPaging="false" CssClass="grd_body"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn DataField="Duedate" HeaderText="Due Date" Visible="false" DataFormatString="{0:MM/dd/yyyy}" SortExpression="Duedate">
                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                    </asp:BoundColumn>
