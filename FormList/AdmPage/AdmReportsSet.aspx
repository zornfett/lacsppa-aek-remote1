<%@ Page Language="C#" AutoEventWireup="true" Inherits="Virweb2.AdmPage.AdmReportsSet" Codebehind="AdmReportsSet.aspx.cs" %>
    ...
    <div algin="left" style="WIDTH:100%;">
	   ...
	   <tr style="height: 30px;background-color: #EAF4FF" valign="middle" >
         ...
         <td align="left" width="60%">
	        <asp:label id="Info" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue">Reports Settings:</asp:label>
	     </td>
