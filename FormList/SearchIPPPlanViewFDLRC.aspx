<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.FormList.SearchIPPPlanViewFDLRC" CodeBehind="SearchIPPPlanViewFDLRC.aspx.cs" %>
          ...
          <tr class="tr_common">
             <td class="td_label">
               <table class="table_inside" cellspacing="0" cellpadding="0">
                 <tr class="tr_common">
                   <td align="left" style="width: 600px" class="td_label">
                      <asp:Label ID="l_plan3" runat="server" Font-Bold="True" Text="Plan for Supports:"></asp:Label>
                   </td>
                   <td align="left" style="width: 400px" >
                   </td>
                 </tr>
