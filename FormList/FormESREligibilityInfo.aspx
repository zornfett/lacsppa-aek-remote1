<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormESREligibilityInfo.aspx.cs" Inherits="Virweb2.FormList.FormESREligibilityInfo" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        ...
        function print_click() {
            ...
            var consumer_key = document.ESREligInfo.consumer_key.value.toString();
            var url = "PrintFormESREligibilityInfo.aspx?entrykey=" + entrykey + "&consumer_key=" + consumer_key + "&flag=" + flag + "&UserAct=" + UserAct;
            winhref(url, 'PrintFormESREligibilityInfo');          
        }
        ...
        function doseltd(obj) {
            ...
            switch (obj.id) {
                case "ESR_RW":
                    ...
                    break;
                case "ESR_RC":
                    Esr_RC.style.display = "";
                    if(btn_ad != null)
                    {
                        document.getElementById('btn_addRecmd').style.display = ""; 
                    }
                    document.ESREligInfo.now_div_flag.value = "2";
                    break;
                case "ESR_MI":
        ...
        function Sign(UserName) {
            ...
            else if ( document.ESREligInfo.checksign.value == "RemoveSign")
            {
               document.ESREligInfo.checksign.value = "RemoveSigned";
            }
            window.document.ESREligInfo.submit(); 
        }
        ...
        function CheckRemoveSignPwd() {
            document.ESREligInfo.checksign.value = "RemoveSign";
            window.showModalDialog("CheckMWESignature.aspx", self, "status:no;dialogWidth:350px;dialogHeight:120px;help:no;scroll:no;resizable:yes;");
        }
        ...
        function UnLockFormPage(key) {
            if (!NoUnlockForm) {
              ...
              type: "POST",
              data: "",
              url: 'FormESREligibilityInfo.aspx?isAjax=true&entrykey=' + key,
              dataType: "json",
                ...
                <td>
                    <table id="TABLE_Label">
                        <tr id="tr_info">
                            ...
                            <td id="ESR_RC" class="tab_sel" onclick="doseltd(this);"
                                 width="150">
        ...
        <table class="table_maindiv">
            <tr class="tr_common">
                <td valign="top" align="center" width="100%" height="100%">
                                    ...
                                    <tr>
                                        <td valign="middle" align="center">
                                            <asp:Label ID="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue"
                                                Height="24px">EARLY START ELIGIBILITY REVIEW</asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                            ...
                            <td>
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        ...
                                        <td  class="td_label" style="width: 170px">
                                            <asp:Label ID="Label6" runat="server" Text="D.O.B:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td  class="td_unline" style="width: 200px">
                                            <asp:Label ID="ClientDOB" runat="server"  CssClass="infaceText"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td  class="td_label" style="width: 170px">
                                            <asp:Label ID="Label5" runat="server" Text="Review Type:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 140px">
                                            <asp:TextBox ID="WeeksGestation"  runat="server" CssClass="inface" Width="100px" MaxLength="50">
                                            </asp:TextBox>   
                                        </td>
                                        <td style="width: 10">
                                        </td>
                                        <td  class="td_label" style="width: 170px">
                                            <asp:Label ID="Label23" runat="server" Text="Next Eligibility Review Date:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td class="td_unline" style="width: 200px">
                                            <asp:TextBox ID="eligreviewdate" runat="server" Width="100px" CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                            ...
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Cognitive_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="FineMotor_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="GrossMotor_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Receptive_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Expresstive_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Emotional_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Adaptive_Delay" runat="server" Width="250px" CssClass="infaceText" Text="0"></asp:Label>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="prog_dutto1" runat="server" Text=""></asp:CheckBox>
                                            <b>Consumer is 0-36 months of age and has a significant DELAY (33%) in one or more developmental areas.</b>
                                        </td>
                                    </tr>
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="prevent_resource_eligible" runat="server" Text=""></asp:CheckBox>
                                            <b>Consumer is at high risk of having a substantial developmental disability.</b>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:Checkbox ID="prog_dutto5" runat="server" Text=""></asp:Checkbox><b>Consumer has a DEVELOPMENTAL DISABILITY and the delays evident constitute a substantial handicap.</b>
                                        </td>
                                    </tr>
                                    <tr style="height: 15px;">
                                        <td>
                                            ...
                                            <table class="table_inside">
                                                <tr class="tr_common">
                                                    <td  class="td_label" style="width: 33%">
                                                        ...
                                                        <br /><asp:TextBox ID="prematurity_text" runat="server" CssClass="inface" MaxLength="100"></asp:TextBox>
                                                    </td>
                                                    ...
                                                    <td  class="td_label" style="width: 36%">
                                                        <table class="table_inside">
                                                            <tr class="tr_common">
                                                                ...
                                                                <td  class="td_label" style="width:100%">
                                                                    <asp:TextBox ID="otherfactor1_text" runat="server" CssClass="inface" MaxLength="100"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr class="tr_common">
                                                    <td  class="td_label" style="width: 33%">
                                                        ...
                                                        <br /><asp:TextBox ID="BW_text" runat="server" CssClass="inface"   MaxLength="100"></asp:TextBox>
                                                    </td>
                                                    <td  class="td_label" style="width: 17%">
                                                    ...
                                                    <td  class="td_label" style="width: 36%">
                                                        <table class="table_inside">
                                                            <tr class="tr_common">
                                                                ...
                                                                <td  class="td_label" style="width:100%">
                                                                    <asp:TextBox ID="otherfactor2_text" runat="server" CssClass="inface" MaxLength="100"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td  class="td_label" style="width: 36%">
                                                        <table class="table_inside">
                                                            <tr class="tr_common">
                                                                ...
                                                                <td  class="td_label" style="width:100%">
                                                                    <asp:TextBox ID="otherfactor3_text" runat="server" CssClass="inface" MaxLength="100"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    ...
                                                    <td  class="td_label" style="width: 36%">
                                                        <table class="table_inside">
                                                            <tr class="tr_common">
                                                                ...
                                                                <td  class="td_label" style="width:100%">
                                                                    <asp:TextBox ID="otherfactor4_text" runat="server" CssClass="inface"  MaxLength="100"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            <b><asp:Checkbox ID="not_prevent_resource_eligible" runat="server" Text=""></asp:Checkbox>NOT ELIGIBLE for the Early Start Program</b>	
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                            ...
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td style="width: 2%"></td>
                                        <td class="td_label"  style="width:49%">
                                            <asp:Checkbox ID="inhome_development" runat="server" Text=""></asp:Checkbox><b>In Home Infant Development: </b>
                                            <asp:TextBox ID="inhome_week" runat="server" CssClass="inface" Width="50px" MaxLength="50"></asp:TextBox>
                                            day(s)
                                            <asp:RadioButton ID="inhome_month_no" GroupName="inhome_month" runat="server" Text="" Checked="true"></asp:RadioButton>
                                            per week
                                            <asp:RadioButton ID="inhome_month_yes" GroupName="inhome_month" runat="server" Text="" Checked="false"></asp:RadioButton>
                                            per month
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td style="width: 2%"></td>
                                        <td class="td_label"  style="width:49%">
                                            <asp:Checkbox ID="centerbase_development" runat="server" Text=""></asp:Checkbox><b>Center Based Infant Development: </b>
                                            <asp:TextBox ID="centerbase_week" runat="server" CssClass="inface" Width="50px" MaxLength="50"></asp:TextBox>
                                            day(s)
                                            <asp:RadioButton ID="centerbase_month_no" GroupName="centerbase_month" runat="server" Text="" Checked="true"></asp:RadioButton>
                                            per week
                                            <asp:RadioButton ID="centerbase_month_yes" GroupName="centerbase_month" runat="server" Text="" Checked="false"></asp:RadioButton>
                                            per month
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="speech_evaluation" runat="server" Text=""></asp:Checkbox>Evaluation&nbsp;&nbsp;&nbsp;</b>
                                            <asp:TextBox ID="speech_week" runat="server" CssClass="inface" Width="50px" MaxLength="50"></asp:TextBox>
                                            day(s)
                                            <asp:RadioButton ID="speech_month_no" GroupName="speech_month" runat="server" Text="" Checked="true"></asp:RadioButton>
                                            per week
                                            <asp:RadioButton ID="speech_month_yes" GroupName="speech_month" runat="server" Text="" Checked="false"></asp:RadioButton>
                                            per month
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            Date:<asp:TextBox ID="ClinicDate" runat="server" Width="100px" CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                                                onfocus="showcalendar(event, this);">
                                            </asp:TextBox>
                                            Time:<asp:TextBox ID="ClinicTime" runat="server" Width="100px" CssClass="inface" >
                                            </asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="occup_evaluation" runat="server" Text=""></asp:Checkbox>Evaluation
                                            <asp:Checkbox ID="occup_consult" runat="server" Text=""></asp:Checkbox>Developmental&nbsp;&nbsp;&nbsp;</b>
                                            <asp:TextBox ID="occup_week" runat="server" CssClass="inface" Width="50px" MaxLength="50"></asp:TextBox>
                                            day(s)
                                            <asp:RadioButton ID="occup_month_no" GroupName="occup_month" runat="server" Text="" Checked="true"></asp:RadioButton>
                                            per week
                                            <asp:RadioButton ID="occup_month_yes" GroupName="occup_month" runat="server" Text="" Checked="false"></asp:RadioButton>
                                            per month
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="physical_evaluation" runat="server" Text=""></asp:Checkbox>Evaluation
                                            <asp:Checkbox ID="physical_consult" runat="server" Text=""></asp:Checkbox>Developmental&nbsp;&nbsp;&nbsp;</b> 
                                            <asp:TextBox ID="physical_week" runat="server" CssClass="inface" Width="50px" MaxLength="50"></asp:TextBox>
                                            day(s)
                                            <asp:RadioButton ID="physical_month_no" GroupName="physical_month" runat="server" Text="" Checked="true"></asp:RadioButton>
                                            per week
                                            <asp:RadioButton ID="physical_month_yes" GroupName="physical_month" runat="server" Text="" Checked="false"></asp:RadioButton>
                                            per month
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                    ...
                                    <tr class="tr_common">
                                        <td class="td_label"  style="width:49%">
                                            <asp:Checkbox ID="provide_monitoring" runat="server" Text=""></asp:Checkbox><b>SC to provide developmental monitoring</b>
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <asp:TextBox ID="monitoring" runat="server" MaxLength="100" Width="300px" CssClass="inface">
                                            </asp:TextBox>
                                        </td>
                                        <td style="width: 2%"></td>
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="BMC" runat="server" Text=""></asp:Checkbox><b>Behavior Management Class</b>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        <td class="td_label"  style="width:49%">
                                            <asp:Checkbox ID="inviteparent" runat="server" Text=""></asp:Checkbox><b>Invite parent to parent training: </b>
                                            <table class="table_inside">
                                                <tr class="tr_common">
                                                    <td  class="td_label" style="width: 50px">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label46" Font-Bold="true" runat="server" Text="Date:"></asp:Label>
                                                    </td>
                                                    <td width="5px">
                                                    </td>
                                                    <td class="td_unline"  style="width: 100px">
                                                        <asp:TextBox ID="invitedate" runat="server" CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                                                            onfocus="showcalendar(event, this);">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td style="width:20px">
                                                    ...
                                                    <td  class="td_label" style="width: 50px">
                                                        <asp:Label ID="Label47" runat="server" Text="Time:" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td width="5px">
                                                    </td>
                                                    <td class="td_unline"  style="width: 100px">
                                                        <asp:TextBox ID="invitetime" runat="server" MaxLength="20" CssClass="inface">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td style="width:auto"></td>
                                            ...
                                            <table class="table_inside">
                                                ...
                                                <tr class="tr_common">
                                                    <td  class="td_label" style="width: 140px">
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label48" runat="server" Text="Training name:" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td width="5px">
                                                    </td>
                                                    <td class="td_unline"  style="width: 150px">
                                                        <asp:TextBox ID="trainingname" runat="server"  CssClass="inface" MaxLength="50">
                                                        </asp:TextBox>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                    <td style="width:auto"></td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label" style="width:49%">
                                            ...
                                            </asp:TextBox> <b>unified school district</b>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        <td colspan="3" class="td_label">
                                            <asp:Checkbox ID="refer_to_other" runat="server" Width="20px" Text=""></asp:Checkbox><b>Other:&nbsp;&nbsp;</b>
                                            <asp:TextBox ID="other_reason" runat="server" CssClass="inface" Width="90%" MaxLength="250"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                      ...
                                      <table class="table_inside">
                                        ...
                                        <tr class="tr_common">
                                           ...
                                           <td colspan=6 class="td_unline">
                                            <asp:TextBox ID="sign_comments" runat="server" Height="40px" TextMode="MultiLine" BorderStyle="Solid" Wrap="true" Width="97%">
                                            </asp:TextBox><br />
                    ...
                    <div id="Esr_RC"  style="display:none;">
