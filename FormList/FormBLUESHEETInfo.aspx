<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormBLUESHEETInfo.aspx.cs"
    Inherits="Virweb2.FormList.FormBLUESHEETInfo" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        ...
        function print_click() {
            ...
            var url = "PrintFormBLUESHEETInfo.aspx?uci=" + consumer_key + "&entrykey=" + entrykey + "&flag=" + flag + "&UserAct=" + UserAct;
        ...
        */
        ...
        function Sign(UserName) {
            ...
            else if ( document.BULESHEETInfo.checksign.value == "RemoveSign")
            {
               document.BULESHEETInfo.checksign.value = "RemoveSigned";
            }
            window.document.BULESHEETInfo.submit(); 
        }
        ...
        function CheckRemoveSignPwd() {
            document.BULESHEETInfo.checksign.value = "RemoveSign";
            window.showModalDialog("CheckMWESignature.aspx", self, "status:no;dialogWidth:350px;dialogHeight:120px;help:no;scroll:no;resizable:yes;");
        }
        ...
        function UnLockFormPage(key) {
            if (!NoUnlockForm) {
              ...
              type: "POST",
              data: "",
              url: 'FormBLUESHEETInfo.aspx?isAjax=true&entrykey=' + key,
              dataType: "json",
                ...
                <td>
                    <table id="TABLE_Label">
                        <tr id="tr_info">
                            ...
                            <td id="TAB_New" class="tab_sel" style="display: none;"  onclick="doseltd(this);" width="200">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc1Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc1&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc2Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc2&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc3Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc3&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc4Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc4&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc5Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc5&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
                                        ...
                                        <tr class="tr_common">
                                            ...
                                            <td>
                                                <input type="button" value="ICD10 Code" style="width: 100px" id="Cmmc6Srch" runat="server"
                                                    onclick="DataChanged();javascript:popupDialogSmall('SearchICD10.aspx?FieldName=Cmmc6&FormName=BULESHEETInfo');" />
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td  class="td_label" style="width: 150px">
