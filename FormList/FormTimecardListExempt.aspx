<%@ Page Language="C#" Inherits="Virweb2.FormList.FormTimecardListExempt" Codebehind="FormTimecardListExempt.aspx.cs" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <base target="_self" />
    <title>:: Exempt Timecard List:::...</title>
		...
		<div align="center" style="WIDTH:100%">  
	       ...
	       <tr style="height: 30px; background-color: #EAF4FF">
             ...
             <td align="left" valign="middle" width="60%">
		        <asp:label id="Info" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue" >Exempt TimeCard</asp:label>
             </td>
