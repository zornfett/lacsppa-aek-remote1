<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormPsychoSocial.aspx.cs" Inherits="Virweb2.FormList.FormPsychoSocial" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        ...
        function print_click() {
            ...
            var url = "PrintFormPsychoSocial.aspx?uci=" + uci + "&flag=" + flag + "&UserAct=" + UserAct;;
                                ...
                                <td>
                                    <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                             ...
                                             <td class="td_unline">
                                                <asp:TextBox ID="Request_Evalation" runat="server" CssClass="inface" MaxLength="150"></asp:TextBox>
                                             </td>
                                        </tr>
                                    </table>    
                                </td>
                                ...
                                <td>
                                    <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                                        <tr class="tr_common">
                                             ...
                                             <td class="td_unline" style="width: 160px;">
                                                 <asp:Label ID="lbl_language" runat="server" CssClass="infaceText"></asp:Label>
                                             </td>
                                ...
                                <td>
                                    <table class="table_inside">
                                        ...
                                        <tr class="tr_common">
                                            <td style="width: 60px"></td>
                                            <td class="td_label">
                                                <asp:Label ID="Label46" runat="server" Text="&nbsp;PM Signature" Font-Bold="True"></asp:Label>
                                            </td>
                                            <td width="35px">
                                            </td>
                                            <td class="td_label">
