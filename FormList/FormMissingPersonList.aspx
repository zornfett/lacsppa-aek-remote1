<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormMissingPersonList.aspx.cs" Inherits="Virweb2.FormList.FormMissingPersonList" %>
...
<head>
        <base target="_self" />
		<title>:::Missing Person List:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
        ...
        <script type="text/javascript">
            ...
            function add_click(uci) {
                document.location.replace("FormMissingPersonInfo.aspx?type=add");
            }

        </script>        
</head>
<body onload="onloadsizechg(50);" onresize="onloadsizechg(50);">
    <form id="MissingPersonList" method="post" runat="server">
        <asp:hiddenfield id="hdnRefreshData" runat="server" value="0" />
	           ...
	           <tr style="height: 30px;background-color: #EAF4FF" valign="middle" >
	             <td align="left" valign="middle" width="25%">
                    ...
                    <input type="image" id="btnBack" runat="server" alt="Back" style="width: 25px;height:25px"  
                        ...
                        onclick="javascript:document.location.replace('../weblist/webConsumerInfo.aspx');return false;" />          
                 </td>  
            ...
            <div  id="maindiv" align="center" style="position:relative;WIDTH:100%;height:450px;  overflow: auto ">
				<asp:datagrid id="dg_FormMissingPerson" runat="server" AllowPaging="false" CssClass="grd_body"
					...
					<Columns>
                        ...
                        <asp:BoundColumn DataField="lastseendate" HeaderText="Date Last Seen" DataFormatString="{0:MM/dd/yyyy}">
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                        </asp:BoundColumn>	
                        ...
                        <asp:BoundColumn DataField="contactinfo" HeaderText="Contact Info">
                            <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                        </asp:BoundColumn>	
