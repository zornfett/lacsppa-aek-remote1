<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTFollowupResident.aspx.cs" Inherits="Virweb2.FormList.FormMTFollowupResident" %>
    ...
    <!--
        function print_click() {
            ...
            if (document.MTInfo.link_mtid.value == document.MTInfo.main_mtid.value)
                isfollowup="0";   
            winhref("PrintFormMTFollowupResident.aspx?MTID="+entrykey+"&IsFollowup="+isfollowup,"PrintFormMTFollowupResident");         
        }
        ...
        function back_click() {
            if (Confirm_Page())
               document.location.replace(document.MTInfo.gobackPage.value+"?MTID="+document.MTInfo.main_mtid.value);
        }
        ...
        function AddCitation(ItemNo,Qno)
        {
            document.MTInfo.SelItemNo.value = ItemNo; 
            var entrykey=document.MTInfo.entrykey.value.toString();
            popupDialog("FormMTCitationResident.aspx?MTID=" + entrykey + "&FormType=Follow Up&Qno=" + Qno + "&type=add");
        ...
        function EditCitation(ItemNo,CitationID,Qno,bedit)
        {
            document.MTInfo.SelItemNo.value = ItemNo;
            if (bedit==1)
               popupDialog("FormMTCitationResident.aspx?CitationID=" + CitationID + "&Qno=" + Qno + "&type=edit");
            else  
               popupDialog("FormMTCitationResident.aspx?CitationID=" + CitationID + "&Qno=" + Qno );
            ...
            <tr class="tr_common">
                <td>
                    <table class="table_inside">
                        ...
                        <tr class="tr_common">
                            <td  class="td_label" style="width: 100px">
                                <asp:Label ID="Label11" runat="server" Text="QA Monitor:" Font-Bold="true"></asp:Label>
                            </td>
                            <td width="5">
                            </td>
                            <td  class="td_unline" style="width: 200px">
			...
			<asp:TemplateColumn HeaderText="">
			    ...
			    <ItemTemplate>
                    <table class="table_inside" cellspacing="0" cellpadding="0">
                       ...
                       <tr class="tr_common">
                          <td class="td_label">
                              <asp:Label ID="Label3" runat="server" Text="COMMENTS/DEFICIENCIES:" ></asp:Label>
                          </td>
                       </tr>
                       <tr class="tr_common">
                           <td class="td_unline">
                       ...
                       <tr class="tr_common">
                          <td class="td_label">
                              <asp:Label ID="Label1" runat="server" Text="RECOMMENDATIONS/ CORRECTION:" ></asp:Label>
                          </td>
                       </tr>
                       <tr class="tr_common">
                           <td class="td_unline">
                       ...
                       <tr class="tr_common">
                          <td class="td_label">
                              <asp:Label ID="l_timeline" runat="server" Text="TimeLine" ></asp:Label>
                          </td>
                       </tr>
                       <tr style="height:10px">
                          <td>
                       ...
                       <tr class="tr_common">
                          <td class="td_label">
                              <asp:Label ID="l_action" runat="server" Text="Action" ></asp:Label>
                          </td>
                       </tr>
                    </table>
                </ItemTemplate>
