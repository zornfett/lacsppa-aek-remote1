<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormIFSPPlan.aspx.cs" Inherits="Virweb2.FormList.FormIFSPPlan" %>
                ...
                <table>
                    <tr class="tr_common">
                        ...
                        <td style="width: 750px" align="left" class="td_unline">
                            <asp:Textbox ID="ServiceFundingType" runat="server" CssClass="inface" MaxLength="100"></asp:Textbox>
                        </td>
                    </tr>
                </table>
            </td>
