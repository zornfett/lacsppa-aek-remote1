<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.FormList.FormIPPInfo"
    CodeBehind="FormIPPInfo.aspx.cs" %>
...
*/
    ...
    <!--
       ...
       function MeetingLocation_click()
       {
            ...
            {
              document.IPPInfo.MeetingLocation.value = document.getElementById('<%= this.Address.ClientID %>').innerHTML;
            }
       }
       /*
...
<body runat="server" id="body">
    ...
    <input type="hidden" name="gobackPage" id="gobackPage" value="FormIPPList.aspx" runat="server" />
                ...
                <table class="table_common" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="tr_common">
                        ...
                        <td  style="width: 280px" >
                            <asp:dropdownlist id="c_medicaid_waiver" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
                    ...
                    <tr class="tr_common">
                        ...
                        <td  style="width: 280px" class="td_unline"  >
                            <asp:Label ID="c_residence_current_desc" runat="server" CssClass="infaceText" ></asp:Label>
                            <asp:DropDownList ID="c_residence_current" OnClick="DataChanged()" Visible="false"  runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_textID"
                                     CssClass="infaceDropRead" Enabled="false">
                            </asp:DropDownList>
                        </td>
                        <td width="5" >
                        </td>
                        ...
                        <td style="width: 180px" class="td_unline"  >
                            <asp:Label ID="c_phone_1" runat="server"  CssClass="infaceText" ></asp:Label>
                        </td>
                        <td style="width: 180px"  class="td_label" >
                    ...
                    <tr class="tr_common">
                        <td style="width: 99%" class="td_unline" >
                            <asp:TextBox ID="GeneralInfo" TextMode="MultiLine" Wrap="true" BorderStyle="Solid"
                                runat="server" Width="99%" Height="250" ReadOnly="true" CssClass="infaceText"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="height:5px;">
                        <td>
                ...
                <table class="table_common" cellspacing="0" cellpadding="0">
                    ...
                    <tr class="tr_common">
                        <td style="width: 99%" class="td_unline" >
                            <asp:TextBox ID="DisorderFrequency" TextMode="MultiLine" Wrap="true" BorderStyle="Solid"
                                runat="server" Width="99%" Height="90" ReadOnly="true" CssClass="infaceText"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="height:5px;">
                        <td>
                            ...
                            <table class="table_inside">
                                <tr class="tr_common">
                                    ...
                                    <td  style="width: 100px" class="td_unline"  >
                                        <asp:Label ID="hgt" runat="server" CssClass="infaceText"></asp:Label>
                                    </td>
                                    <td style="width: 5px">
                                    </td>
                                    <td style="width: 120px"  class="td_label" >
                                    ...
                                    <td style="width: 100px" class="td_unline"  >
                                        <asp:Label ID="wgt" runat="server" CssClass="infaceText" ></asp:Label>
                                    </td>
                            ...
                            <table>
                                <tr class="tr_common">
                                    ...
                                    <td  style="width: 150px" class="td_label" >
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <asp:Radiobutton ID="Hospitalization_no" groupname="Hospitalization" runat="server" Text="" Checked="false"></asp:Radiobutton><b>No</b>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td>
                            <table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="95%" >
	                            <tr class="tr_common">
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="apsymn" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="adepmn" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
								            <asp:ListItem Value="1">Yes</asp:ListItem>
								            <asp:ListItem Value="2">No</asp:ListItem>
								        </asp:dropdownlist>
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="aanxmn" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
								            <asp:ListItem Value="1">Yes</asp:ListItem>
								            <asp:ListItem Value="2">No</asp:ListItem>
								        </asp:dropdownlist>
                                ...
                                <tr class="tr_common">
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="sedhyp" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
								            <asp:ListItem Value="1">Yes</asp:ListItem>
								            <asp:ListItem Value="2">No</asp:ListItem>
								        </asp:dropdownlist>
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="stmlnt" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
								            <asp:ListItem Value="1">Yes</asp:ListItem>
								            <asp:ListItem Value="2">No</asp:ListItem>
								        </asp:dropdownlist>
                                    ...
                                    <td  width="5"></td>
                                    <td style="width: 75px" >
								        <asp:dropdownlist id="othdrg" runat="server" Enabled="false" CssClass="infaceDropRead" OnClick="DataChanged()">
									        <asp:ListItem Value=""></asp:ListItem>
								            <asp:ListItem Value="1">Yes</asp:ListItem>
								            <asp:ListItem Value="2">No</asp:ListItem>
								        </asp:dropdownlist>
                    ...
                    <tr class="tr_common">
                        <td>
						    ...
						    <asp:BoundColumn DataField="medication" HeaderText="Medication" >
                            ...
                            <asp:BoundColumn DataField="mdreviewDate" HeaderText="MD's Review Date"  DataFormatString="{0:MM/dd/yyyy}">
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                            </asp:BoundColumn>
					        </Columns>
				            </asp:datagrid> 
                    ...
                    <tr class="tr_common">
                        <td>
                            <asp:datagrid id="dg_DoctorList" runat="server" AllowPaging="false" CssClass="grd_bodyborder"
	                                ...
	                                <table class="table_inside" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr class="tr_common">     
                                            <td  class="td_label" style="width: 250px">
                                                <asp:Label ID="Label146" runat="server" Font-Bold="true" Text='<%# DataBinder.Eval(Container.DataItem, "Relationship").ToString().TrimEnd() %>'></asp:Label>
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="Label142" CssClass="infaceText" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Name").ToString().TrimEnd() %>'></asp:Label>
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr_common">     
                                            <td  class="td_label" style="width: 250px">
                                                <asp:Label ID="Label35" runat="server" Font-Bold="true"  Text="Address:"></asp:Label>
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="Label36" CssClass="infaceText" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Address").ToString().TrimEnd() %>'></asp:Label>
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="tr_common">     
                                            <td  class="td_label" style="width: 250px">
                                                <asp:Label ID="Label37" runat="server" Font-Bold="true" Text="Telephone:"></asp:Label>
                                            </td>
                                            <td width="5">
                                            </td>
                                            <td align="left">
                                                <asp:Label ID="Label38" CssClass="infaceText" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Phone").ToString().TrimEnd() %>'></asp:Label>
                                            </td>
                                            <td>
                                            </td>
                                        </tr>
                    ...
                    <tr class="tr_common">
                        <td>
						    ...
						    <asp:BoundColumn DataField="doctorcomments" HeaderText="Reason for Visit" >
                                <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                            </asp:BoundColumn>
					        </Columns>
				            </asp:datagrid> 
                    ...
                    <tr class="tr_common">
                        <td style="width: 99%" class="td_unline" >
                            <asp:TextBox ID="ChronicMed" TextMode="MultiLine" Wrap="true" BorderStyle="Solid"
                                runat="server" Width="99%" Height="120" ReadOnly="true" CssClass="infaceText"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="height:5px;">
                        <td>
                    ...
                    <tr class="tr_common">
                        <td style="width: 99%" class="td_unline" >
                            <asp:TextBox ID="SkillCderNarrative" TextMode="MultiLine" Wrap="true" BorderStyle="Solid"
                                runat="server" Width="99%" Height="150" ReadOnly="true" CssClass="infaceText"></asp:TextBox>
                        </td>
                    </tr>
                    <tr style="height:5px;">
                        <td>
                                    ...
                                    <tr><td colspan="3">
                                        ...
                                        <tr class="tr_common">
                                           ...
                                           <td align="left" width="300">
                                              <asp:Label ID="c_legal_status_1_desc"  runat="server" CssClass="infaceText" ></asp:Label>
                                              <asp:DropDownList ID="c_legal_status_1" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="fullentry"
                                           ...
                                           <td class="td_unline"  width="300">
                                              <asp:TextBox ID="c_legal_status_date_1"  runat="server"
                                        ...
                                        <tr class="tr_common" style="display:none">
                                            ...
                                            <td align="left" width="300">
                                                <asp:Label ID="c_legal_status_2_desc"  runat="server" CssClass="infaceText" ></asp:Label>
                                               <asp:DropDownList ID="c_legal_status_2" Visible="false"  runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                  CssClass="infaceDrop" OnClick="DataChanged()">
                                               </asp:DropDownList>
                                            </td>
                                            <td  width="210" class="td_label" >
                                            ...
                                            <td class="td_unline"  width="300">
                                               <asp:TextBox ID="c_legal_status_date_2"  runat="server"
                                                  CssClass="inface"></asp:TextBox>
                                        ...
                                        <table class="table_inside" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td class="td_unline" style="width:300px">
							                        <asp:textbox id="IDTeamdate" runat="server" CssClass="inface">
                                                    </asp:textbox>
						                        </td>
                                            </tr>
                                            <tr style="height:5px;">
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td align="left" width="300">
                                                    <asp:Label ID="cons_type_desc"  runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="cons_type" Visible="false"   runat="server" DataValueField="tb_entry_name"
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td class="td_unline" style="width:300px">
							                        <asp:textbox id="cons_establishdate" runat="server" CssClass="inface"></asp:textbox>
						                        </td>
                                            </tr>
                                            <tr style="height:5px;">
                                                <td colspan="3">
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td align="left" width="300">
                                                    <asp:Label ID="cons_relationship1_desc"  runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="cons_relationship1" Visible="false"   runat="server" DataValueField="tb_entry_name"
                                                        DataTextField="tb_entry_text"  CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Conservator2_Tab" runat="server" style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="cons_relationship2_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="cons_relationship2" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Conservator3_Tab"  runat="server" style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="cons_relationship3_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="cons_relationship3" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Conservator4_Tab" runat="server"  style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="cons_relationship4_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="cons_relationship4" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                    ...
                                    <td align="left" valign="top" style="width:49%">
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td  width="300">
                                                    <asp:Label ID="grd_type_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="grd_type" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                        DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td class="td_unline" style="width:300px">
							                        <asp:textbox id="grd_establishdate" runat="server" CssClass="inface" onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);"></asp:textbox>
						                        </td>
                                            </tr>
                                            <tr style="height:5px;">
                                                <td colspan="3">
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td width="5"></td>
                                                <td align="left" width="300">
                                                    <asp:Label ID="grd_relationship1_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="grd_relationship1" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                        DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Guardian2_Tab" runat="server"  style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="grd_relationship2_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="grd_relationship2" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Guardian3_Tab" runat="server"  style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="grd_relationship3_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="grd_relationship3" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr class="tr_common">
                                                <td colspan="3">
                                                    <table id="Guardian4_Tab" runat="server"  style="display:none" class="table_inside" cellspacing="0" cellpadding="0">
                                                         <tr>
                                                            <td colspan="3" class="td_thicksepline">
                                                            </td>
                                                         </tr>
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td width="5"></td>
                                                            <td align="left" width="300">
                                                                <asp:Label ID="grd_relationship4_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="grd_relationship4" Visible="false" runat="server" DataValueField="tb_entry_name"
                                                                    DataTextField="tb_entry_text" CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                    ...
                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                        <tr class="tr_common">
                                            ...
                                            <td align="left" width="105" >
                                                <asp:Label ID="sex_offender_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                <asp:DropDownList ID="sex_offender" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                    CssClass="infaceDrop" OnClick="DataChanged()">
                                                </asp:DropDownList>
                                            </td>
                                            <td>&nbsp;</td>
                                        ...
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td align="left" width="200" >
                                                    <asp:Label ID="registerstation" runat="server"  CssClass="infaceText" ></asp:Label>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td style="width:auto"></td>
                                            </tr>
                                        ...
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td class="td_unline" style="width:100px" colspan="2">
							                        <asp:textbox id="registerdate" runat="server" CssClass="inface"></asp:textbox>
						                        </td>
                                                <td>&nbsp;</td>
                                                <td style="width:auto"></td>
                                            </tr>
                                        ...
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td align="left" width="100" >
                                                    <asp:Label ID="strikes_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                    ...
                                    <td >
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td align="left" width="100" >
                                                    <asp:Label ID="strikes_cnt_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="strikes_cnt" Visible="false" runat="server"
                                                        CssClass="infaceDrop" OnClick="DataChanged()">
                                                        <asp:ListItem Value=""></asp:ListItem>
	                                            ...
	                                            <table class="table_inside" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label59" runat="server" Font-Bold="true"  Text="Case Number:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="100">
                                                                        <asp:TextBox ID="casenumber"  Text='<%# DataBinder.Eval(Container.DataItem, "casenumber") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Current Criminal Charge(s):"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td align="left" width="250px">
                                                                        <asp:Label ID="criminal_charge" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "criminal_charge").ToString().TrimEnd()%>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label60" runat="server" Font-Bold="true" Text="Type:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td align="left" width="250px">
                                                                        <asp:Label ID="criminal_type" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "criminal_type").ToString().TrimEnd()%>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Courthouse:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="350px">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Division:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="350px">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Date of arrest:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="100">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label8" runat="server" Font-Bold="true" Text="Housing:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td align="left" width="250px">
                                                                        <asp:Label ID="housing" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "housing_desc").ToString().TrimEnd()%>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label9" runat="server" Font-Bold="true" Text="Attorney/Public Defender Name:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="230px">
                                                                        <asp:TextBox ID="defendername" Text='<%# DataBinder.Eval(Container.DataItem, "defendername") %>'  runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td width="20">
                                                                    </td>
                                                                    <td  class="td_label" style="width: 250px">
                                                                        <asp:Label ID="Label61" runat="server" Font-Bold="true" Text="Phone Number:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="150">
                                                                        <asp:TextBox ID="defender_phone" Text='<%# DataBinder.Eval(Container.DataItem, "defender_phone") %>' runat="server" CssClass="inface" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label12" runat="server" Font-Bold="true" Text="Court Dates:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="80px">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label13" runat="server" Font-Bold="true" Text="Number of Strikes:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"   width="230px">
                                                                        <asp:TextBox ID="strikes_total_desc"  Text='<%# DataBinder.Eval(Container.DataItem, "strikes_total_desc") %>' runat="server" CssClass="infaceText"  MaxLength="5"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label14" runat="server" Font-Bold="true" Text="Current judicial status:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="250px">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label15" runat="server" Font-Bold="true" Text="End Date of current judicial status:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label16" runat="server" Font-Bold="true" Text="If IST is consumer receiving CST Training?"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td align="left" width="230px">
                                                                        <asp:Label ID="ist" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ist_desc").ToString().TrimEnd()%>'>
                                                                        </asp:Label>
                                                                    </td>
                                                                    <td width="20">
                                                                    </td>
                                                                    <td  class="td_label" style="width: 140px">
                                                                        <asp:Label ID="Label17" runat="server" Font-Bold="true" Text="Name of CST:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="150">
                                                                        <asp:TextBox ID="cstname" Text='<%# DataBinder.Eval(Container.DataItem, "cstname") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label18" runat="server" Font-Bold="true" Text="If on Parole or Probation Name of Probation Officer:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="230px">
                                                                        <asp:TextBox ID="prob_officername" Text='<%# DataBinder.Eval(Container.DataItem, "prob_officername") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td width="20">
                                                                    </td>
                                                                    <td  class="td_label" style="width: 250px">
                                                                        <asp:Label ID="Label19" runat="server" Font-Bold="true" Text="Phone Number:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="150">
                                                                        <asp:TextBox ID="officer_phone" Text='<%# DataBinder.Eval(Container.DataItem, "officer_phone") %>' runat="server" CssClass="inface" MaxLength="15"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="If in prison name of prison:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="230px">
                                                                        <asp:TextBox ID="prisonname" Text='<%# DataBinder.Eval(Container.DataItem, "prisonname") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td width="20">
                                                                    </td>
                                                                    <td  class="td_label" style="width: 250px">
                                                                        <asp:Label ID="Label64" runat="server" Font-Bold="true" Text="Scheduled Date of Release:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="100">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label20" runat="server" Font-Bold="true" Text="Entered By:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"   width="230px">
                                                                        <asp:TextBox ID="judicial_sc" Text='<%# DataBinder.Eval(Container.DataItem, "judicial_sc") %>' ReadOnly="true" runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td>&nbsp;</td>
                                                                    <td style="width: auto">
                                                                    </td>
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px">
                                                                        <asp:Label ID="Label21" runat="server" Font-Bold="true" Text="Closed Case:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                                    <td class="td_unline"  width="120">
                                                    ...
                                                    <tr class="tr_common">
                                                        <td>
                                                            <table class="table_common" cellspacing="0" cellpadding="0">
                                                                <tr class="tr_common">
                                                                    <td  class="td_label" style="width: 340px" valign="top">
                                                                        <asp:Label ID="judicialcomments" runat="server" Font-Bold="true" Text="Comments:"></asp:Label>
                                                                    </td>
                                                                    <td width="5">
                                                                    </td>
                                                    ...
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label69" runat="server" Font-Bold="true" Text="IPP Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left"  style="width: 105px">
                                                                <asp:Label ID="Label72" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ippdate", "{0:d}") %>' CssClass="infaceText"></asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Is Consumer Registered to vote?"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left" width="105px">
                                                                <asp:Label ID="voter_reg" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "voter_reg_desc").ToString().TrimEnd()%>'>
                                                                </asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label73" runat="server" Font-Bold="true" Text="Was an NVRA Voter Form Completed?"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left" width="105px">
                                                                <asp:Label ID="nvra_voter" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "nvra_voter_desc").ToString().TrimEnd()%>'>
                                                                </asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="If No, please explain:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="If Voter Registration completed by Regional Center Registration Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="Additional Comments:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td style="height: 40px" valign="top">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Next NVRA Form due:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td  class="td_label" style="width: 105px">
                                                                <asp:Label ID="next_nvra_due" Text='<%# DataBinder.Eval(Container.DataItem, "next_nvra_due", "{0:d}") %>' runat="server"  CssClass="infaceText"></asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label55" runat="server" Font-Bold="true" Text="IPP Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left"  style="width: 105px">
                                                                <asp:Label ID="ippdate" runat="server"  CssClass="infaceText" Text='<%# DataBinder.Eval(Container.DataItem, "ippdate", "{0:d}") %>'></asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Did Family provide income documentation?"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left" width="100">
                                                                <asp:Label ID="income_doc" CssClass="infaceText" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "income_doc_desc").ToString().TrimEnd()%>'>
                                                                </asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label56" runat="server" Font-Bold="true" Text="Family Cost Participation Program Assessment Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Share of Cost Assessment %:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                                                <asp:TextBox ID="cost_share" Text='<%# DataBinder.Eval(Container.DataItem, "cost_share") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label4" runat="server" Font-Bold="true" Text="Did Family meet the exception?"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left" width="100">
                                                                <asp:Label ID="exception" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "exception_desc").ToString().TrimEnd()%>'>
                                                                </asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="Services effected:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="300">
                                                                <asp:TextBox ID="service_effected" Text='<%# DataBinder.Eval(Container.DataItem, "service_effected") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Share of POS hours:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                                                <asp:TextBox ID="pos_share" Text='<%# DataBinder.Eval(Container.DataItem, "pos_share") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label8" runat="server" Font-Bold="true" Text="Family Size:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                                                <asp:TextBox ID="familysize" Text='<%# DataBinder.Eval(Container.DataItem, "familysize") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label9" runat="server" Font-Bold="true" Text="Date Letter Mailed to family:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label57" runat="server" Font-Bold="true" Text="Next FCPP due:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left"  style="width: 105px">
                                                                <asp:Label ID="next_fcpp" Text='<%# DataBinder.Eval(Container.DataItem, "next_fcpp", "{0:d}") %>' runat="server"  CssClass="infaceText"></asp:Label>
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label63" runat="server" Font-Bold="true" Text="IPP Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left"  style="width: 105px">
                                                                <asp:Label ID="ippdate" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ippdate", "{0:d}") %>' CssClass="infaceText"></asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label70" runat="server" Font-Bold="true" Text="Annual Family Program Fee Assessment Date:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label3" runat="server" Font-Bold="true" Text="Fee Amount:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  width="100">
                                                                <asp:TextBox ID="feeamount" Text='<%# DataBinder.Eval(Container.DataItem, "feeamount") %>' runat="server" CssClass="inface" MaxLength="50"></asp:TextBox>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label7" runat="server" Font-Bold="true" Text="Family paid Fee to DDS"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left" width="100">
                                                                <asp:Label ID="pay_DDS" CssClass="infaceText"  runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "pay_DDS_desc").ToString().TrimEnd()%>'>
                                                                </asp:Label>
                                                            </td>
                                                            <td>&nbsp;</td>
                                                            <td style="width: auto">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label9" runat="server" Font-Bold="true" Text="Date 1st Notice Letter Mailed to family:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label6" runat="server" Font-Bold="true" Text="Date 2nd Notice Letter Mailed to family:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td class="td_unline"  style="width: 105px">
                                            ...
                                            <tr class="tr_common">
                                                <td>
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label" style="width: 400px">
                                                                <asp:Label ID="Label71" runat="server" Font-Bold="true" Text="Next AFPF due:"></asp:Label>
                                                            </td>
                                                            <td width="5">
                                                            </td>
                                                            <td align="left"  style="width: 105px">
                                        ...
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td align="left" width="80px">
                                                    <asp:Label ID="given_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="given" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                             CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td> 
                                                ...
                                                <td align="left" width="80px">
                                                    <asp:Label ID="lifeplan_developed_desc" runat="server"  CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="lifeplan_developed" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                            CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>&nbsp;</td>
                                    ...
                                    <td >
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common" >
                                                <td >
                                                    <table class="table_common" cellspacing="0" cellpadding="0">
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td align="left" width="80px">
                                                                <asp:Label ID="burial_arrangement1_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="burial_arrangement1" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                                        CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td> 
                                                        </tr>
                                                ...
                                                <td  >
                                                    <table id="plan2"  runat="server"  style="display:none" class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label"  style="width: 250px">
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td align="left" width="80px">
                                                                <asp:Label ID="burial_arrangement2_desc" runat="server"  CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="burial_arrangement2" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                                        CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td> 
                                                        </tr>
                                                ...
                                                <td >
                                                    <table id="plan3"  runat="server"  style="display:none" class="table_common" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                            <td  class="td_label"  style="width: 250px">
                                                        ...
                                                        <tr class="tr_common">
                                                            ...
                                                            <td align="left" width="80px">
                                                                <asp:Label ID="burial_arrangement3_desc" runat="server" CssClass="infaceText" ></asp:Label>
                                                                <asp:DropDownList ID="burial_arrangement3" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                                        CssClass="infaceDrop" OnClick="DataChanged()">
                                                                </asp:DropDownList>
                                                            </td> 
                                                        </tr>
                                    ...
                                    <td >
                                        <table class="table_common" cellspacing="0" cellpadding="0">
                                            <tr class="tr_common">
                                                ...
                                                <td align="left" width="200" >
                                                    <asp:Label ID="trusttype_desc" runat="server"  CssClass="infaceText" ></asp:Label>
                                                    <asp:DropDownList ID="trusttype" Visible="false" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                                        CssClass="infaceDrop" OnClick="DataChanged()">
                                                    </asp:DropDownList>
                                                </td>
                                                <td>&nbsp;</td>
                                            ...
                                            <tr class="tr_common">
                                                ...
                                                <td style="height: 60px" valign="top">
                                                    <asp:TextBox ID="contactinfo" TextMode="MultiLine" Wrap="true" BorderStyle="Solid"
                                                        runat="server" Width="99%" Height="60"></asp:TextBox>
                                                    <cc1:UltimateSpell ID="UltimateSpell45" ControlIdsToCheck="contactinfo" ShowModal="true"
