<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTDayProgramFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormMTDayProgramFDLRC" %>
...
<head>
    <base target="_self" />
    <title>:::Adult Day Program (ADP):::...</title>
    ...
    <!--
        ...
        function DropDownListChange(Qno, CitaID)
        {
            ...
            if ((Value == 2) || (Value == 3)) 
            {
                ...
                {
                  var entrykey=document.MTInfo.entrykey.value.toString();
                  popupDialog("FormMTCitationFDLRC.aspx?MTID=" + entrykey + "&FormType=Annual Day Program Review&Qno=" + Qno + "&type=add");
                }
            } 
            else
            {
          ...
          <td valign="top" align="center" width="100%" height="100%">
             <div id="Tab1">
                    <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%;height:100%">
                                    ...
                                    <tr>
                                        <td valign="middle" align="center">
                                            <asp:Label ID="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue"
                                                Height="24px" Text="ADULT DAY PROGRAM (ADP)"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                ...
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 250px">
                                            <asp:Label ID="Label15" runat="server" Text="Required Staff-to-Client Ratio:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 50px;" class="td_unline">
                                            <asp:TextBox ID="RequireRatio" runat="server" CssClass="inface" MaxLength="10"></asp:TextBox>
                                        </td>
                                        <td  class="td_label" style="width: 250px">
                                            <asp:Label ID="Label16" runat="server" Text="Number of Direct Support Staff:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 50px;" class="td_unline">
                                            <asp:TextBox ID="StaffNum" runat="server" CssClass="inface" MaxLength="5"></asp:TextBox>
                                        </td>
                                        <td  class="td_label" style="width: 150px">
                                            <asp:Label ID="Label17" runat="server" Text="Number of Clients:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 50px;" class="td_unline">
                                            <asp:TextBox ID="ClientNum" runat="server" CssClass="inface" MaxLength="5"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td  style="width: 400px" class="td_unline" >
                                            <asp:DropDownList ID="FormType" runat="server" width="380px" CssClass="infaceDropText" Enabled="false">
                                                 <asp:ListItem Value="Annual Day Program Review" Selected="True">Adult Day Program (ADP)</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td width="10">
                                        </td>
                        ...
                        <tr class="tr_common">
                            <td  class="td_label">
                               <b><asp:Label ID="l_sitesdate" runat="server" Text="Site(s) and Date(s) Visited: (Non-Center Based Programs Only)" ></asp:Label></b>
                            </td>
                        </tr>
                        <tr class="tr_common">
                        ...
                        <tr style="height:30px;">
                            <td><b>PROGRAM IMPLEMENTATION (All Programs)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>STAFFING (All Programs)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>RECORDS (All Programs)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>PHYSICAL ENVIRONMENT (Center-based only)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
