<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTSLSFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormMTSLSFDLRC" %>
...
<head>
    <base target="_self" />
    <title>:::Supported Living Services (SLS) Program:::...</title>
    ...
    <!--
        ...
        function DropDownListChange(Qno, CitaID)
        {
            ...
            if ((Value == 2) || (Value == 3)) 
            {
                ...
                {
                  var entrykey=document.MTInfo.entrykey.value.toString();
                  popupDialog("FormMTCitationFDLRC.aspx?MTID=" + entrykey + "&FormType=SLS Quality Assurance Evaluation&Qno=" + Qno + "&type=add");
                }
            } 
            else
            {
                    ...
                    <table id="TABLE_Label">
                        <tr id="tr_info">
                            <td id="TAB1" style="color:#990066;" class="tab_sel" onclick="doseltd(this);"
                                 width="300">
                                <b><u>Supported Living Services</u></b>
                            </td>
          ...
          <td valign="top" align="center" width="100%" height="100%">
             <div id="Tab1">
                    <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%;height:100%">
                                    ...
                                    <tr>
                                        <td valign="middle" align="center">
                                            <asp:Label ID="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue"
                                                Height="24px" Text="SUPPORTED LIVING SERVICES (SLS) PROGRAM"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td  style="width: 400px" class="td_unline" >
                                            <asp:DropDownList ID="FormType" runat="server" width="380px" CssClass="infaceDropText" Enabled="false">
                                                 <asp:ListItem Value="SLS Quality Assurance Evaluation" Selected="True">Supported Living Services (SLS) Program</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td width="10">
                                        </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>COMMUNITY INTEGRATION</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>SOCIAL-PSYCHOLOGICAL ENVIRONMENT</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>PHYSICAL ENVIRONMENT AND SAFETY</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
