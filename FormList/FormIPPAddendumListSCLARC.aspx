<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormIPPAddendumListSCLARC.aspx.cs" Inherits="Virweb2.FormList.FormIPPAddendumListSCLARC" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/javascript">
        ...
        {
            document.location.replace("FormIPPAddendumInfoSCLARC.aspx?ClientID="+uci+"&tabno=14&type=add");
        }
        function back_click() {
