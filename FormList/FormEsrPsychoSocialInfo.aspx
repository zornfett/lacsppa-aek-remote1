<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEsrPsychoSocialInfo.aspx.cs" Inherits="Virweb2.FormList.FormEsrPsychoSocial" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        ...
        function print_click() {
            ...
            var url = "PrintFormEsrPsychoSocial.aspx?Entrykey="+entrykey+"&uci=" + consumer_key + "&mis=" + consumer_mis +
        ...
        function Sign(UserName) {
            ...
            //}
            //else 
            if (document.ESRPsychoInfo.checksign.value == "Approval")
            {          
        ...
        function CheckFinialPwd() {
          ...
          if (document.getElementById("<%=approved_yes.ClientID %>").checked)  
          {
             document.ESRPsychoInfo.checksign.value = "Approval";
          ...
          {
             document.ESRPsychoInfo.checksign.value = "Return";
             window.document.ESRPsychoInfo.submit(); 
             window.focus();
          }
        }
                                ...
                                <table class="table_inside" cellspacing="0" cellpadding="0">
                                    <tr  class="tr_common">
                                        <td style="width: 160px" class="td_label" >
                                            <b><asp:Label ID="Label27" runat="server" Text="BIC Number:"></asp:Label></b>
                                        </td>
                                        <td width="5">
                                        </td>
                                            ...
                                            <table class="table_inside" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr class="tr_common">
                                                    <td  class="td_label" colspan="5">
                                                      <table class="table_inside" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                          <td  class="td_label" valign="bottom" style="width:220px">
                                                            <asp:Label ID="Label43" runat="server" Font-Bold="true"  Text="Date of Intake Hearing Screening:"></asp:Label>
                                                          </td>
                                                          <td style="width: 5px"></td>
                                                          ...
                                                          <td class="td_label" style="width: auto">
                                                            <asp:Checkbox ID="Hearing_In_Pass" runat="server" Text=""></asp:Checkbox><b>Pass</b>
                                                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <asp:Checkbox ID="Hearing_In_Followup" runat="server" Text=""></asp:Checkbox><b>Follow up</b>
                                                          </td>
                                                        </tr>
                                                      </table>
                                                    </td>
                                                ...
                                                <tr class="tr_common">
                                                    <td  class="td_label" colspan="5">
                                                      <table class="table_inside" cellspacing="0" cellpadding="0">
                                                        <tr class="tr_common">
                                                          <td  class="td_label" valign="bottom" style="width:220px">
                                                             <asp:Label ID="Label21" runat="server" Font-Bold="true"  Text="Date of Intake Vision Screening:"></asp:Label>
                                                          </td>
                                                          <td style="width: 5px"></td>
                                                          <td class="td_unline" style="width: 100px">
                                                          ...
                                                          <td style="width:10px">&nbsp;</td>
                                                          <td class="td_label" style="width: auto">
                                                             <asp:Checkbox ID="Vision_In_Pass" runat="server" Text=""></asp:Checkbox><b>Pass</b>
                                                               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                             <asp:Checkbox ID="Vision_In_Followup" runat="server" Text=""></asp:Checkbox><b>Follow up</b>
                                                          </td>
                                                        </tr>
                                                      </table>
                                                    </td>
