<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormIPPListFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormIPPListFDLRC" %>
    ...
    <script type="text/javascript">
        ...
        function add_click(uci) {
            if (document.IPPList.ippexist.value == "1") {
                ...
                if (saveflag == "1")
                    document.location.replace("FormIPPInfoFDLRC.aspx?uci=" + uci + "&type=add&Prefill=1");
                else if (saveflag == "0")
                    document.location.replace("FormIPPInfoFDLRC.aspx?uci=" + uci + "&type=add");
            }
            else
                document.location.replace("FormIPPInfoFDLRC.aspx?uci=" + uci + "&type=add");
        }

        function addann_click(uci) {
            if (document.IPPList.ippexist.value == "1") {
                var DspStr = "Do you want to bring over your previous Annuals outcomes?";
                var saveflag = PromptSaveChange(1, DspStr);
                if (saveflag == "1")
                    document.location.replace("FormIPPAnnualInfoFDLRC.aspx?uci=" + uci + "&type=add&Prefill=1");
                else if (saveflag == "0")
                    document.location.replace("FormIPPAnnualInfoFDLRC.aspx?uci=" + uci + "&type=add");
            }
            else
                document.location.replace("FormIPPAnnualInfoFDLRC.aspx?uci=" + uci + "&type=add");
        }
...
<body onload="onloadsizechg(50);" onresize="onloadsizechg(50);">
    <form id="IPPList" method="post" runat="server">
        ...
        <div id="mainoutsidediv" align="center" style="position: relative; width: 100%; height: 250px;">
            ...
            <div id="maindiv" align="center" style="position: relative; width: 100%; height: 100%; top: 0px; left: 0px;">
                <h2>IPP</h2>
                <div id="IPPDiv" style="max-height: 600px; overflow-y: scroll;">
                ...
                <br />
                <br />
                <asp:HyperLink  NavigateUrl="#herf_md" ID="btnAnnAdd" runat="server" ImageUrl="../img/add.ico" BorderWidth="0" alt="New" Style="width: 25px; height: 25px; margin-right: 1670px; margin-left: 15px;"></asp:HyperLink>
                <div id="maindivAnnual" runat="server" align="center" style="position: relative; width: 100%; height: 250px;">
                    <h2>Annual Review/Quarterly</h2>
                    <div id="AnnualDiv" style="max-height: 600px; overflow-y: scroll;">
                        <asp:DataGrid ID="IPPListAnnual" runat="server" AllowPaging="false" CssClass="grd_body"
                            ...
                            <FooterStyle CssClass="grd_fsitem"></FooterStyle>
                            <Columns>
                                <asp:BoundColumn DataField="IPPAnnualID" HeaderText="IPPID" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="uci" HeaderText="uci" Visible="false">
                                    <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" />
