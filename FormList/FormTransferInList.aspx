<%@ Page Language="C#" Inherits="Virweb2.FormList.FormTransferInList" Codebehind="FormTransferInList.aspx.cs" AutoEventWireup="True" %>
    ...
    <form id="form1" runat="server">
		    ...
		    <div  id="maindiv" align="center" style="position:relative;WIDTH:100%;height:450px;  overflow: auto ">
                ...
                <Columns>                    
                    ...
                    <asp:BoundColumn DataField="CaseTransferFrom" HeaderText="Transfer From" SortExpression="CaseTransferFrom">
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
                     <asp:BoundColumn DataField="ReceivedDate" HeaderText="Received Date" SortExpression="ReceivedDate" DataFormatString="{0:MM/dd/yyyy}">
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
