<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTFollowupDayPSCLARC.aspx.cs" Inherits="Virweb2.FormList.FormMTFollowupDayPSCLARC" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        ...
        function back_click() {
            if (Confirm_Page())
            {
               document.location.replace("FormMTDayProgramSCLARC.aspx?MTID="+document.MTInfo.main_mtid.value);
            }
        }
        ...
        function RemoveCitation(ItemNo,CitationID)
        {
        ...
        function AddCitation(ItemNo,Qno)
        {
            ...
            popupDialog("FormMTCitationSCLARC.aspx?MTID=" + entrykey + "&FormType=Follow Up&Qno=" + Qno + "&type=add");
                    ...
                    <table class="table_inside">
                        <tr class="tr_common">
                            <td  class="td_label" style="width: 120px">
                                <asp:Label ID="l_progname" runat="server" Text="Program Name:" Font-Bold="true"></asp:Label>
                            </td>
                            <td width="5">
                            </td>
                            <td  style="width: 300px" class="td_unline" >
                                <asp:TextBox ID="ProgName" runat="server" CssClass="inface"></asp:TextBox>
                            </td>
                            <td  class="td_label" style="width: 120px">
                                <asp:Label ID="l_progdate" runat="server" Text="Date:" Font-Bold="true"></asp:Label>
                            </td>
                            <td width="5">
                            </td>
                    ...
                    <table class="table_inside">
                        ...
                        <tr class="tr_common">
                            <td  class="td_label" style="width: 250px">
                                <asp:Label ID="Label86" runat="server" Text="Regional Center Reviewer Signature:" Font-Bold="true"></asp:Label>
                            </td>
                            <td width="5">
                            </td>
                            <td colspan="2">
