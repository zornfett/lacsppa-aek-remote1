<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormESREligibilityList.aspx.cs"
    Inherits="Virweb2.FormList.FormESREligibilityList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html>
<head>
    <base target="_self" />
    <title>:::EARLY START / PREVENTION ELIGIBILITY REVIEW LIST:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/javascript">
        function RefreshMyData()    
        {
          ...
          window.document.ESREligList.submit(); 
          window.focus();   
        }
        ...
        function doseltd(obj) {
            ...
            switch (obj.id) {
                case "ERT_MR":
                    ...
                    document.ESREligList.now_div_flag.value = "1";
                    break;
                case "ERT_AR":
                    Ert_AR.style.display = "";
                    document.ESREligList.now_div_flag.value = "3";
                    break;
            }
        }
...
<body onload="onloadsizechg(110);" onresize="onloadsizechg(110);">
    <form id="ESREligList" method="post" runat="server">
            ...
            <tr style="height: 30px; background-color: #EAF4FF" valign="middle">
                <td align="left" valign="middle" width="25%">
                    ...
                    <input type="image" id="btnBack" runat="server" alt="Back" style="width: 25px; height: 25px"
                        src="../img/back.ico" title="Back" onclick="javascript:document.location.replace('../weblist/webForms.aspx');return false;" />
                </td>
            ...
            <tr style="height: 30px;" valign="middle">
                ...
                <td align="left" width="600px">
                    <asp:Label ID="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Green"
                        Height="18px">EARLY START / PREVENTION ELIGIBILITY REVIEW LIST</asp:Label>
                </td>
            </tr>
    ...
    <div id="maindiv" align="center" style="position: relative; width: 100%; height: 450px;
        ...
        <div id="Ert_MR" align="center" style="position: relative; width: 100%; height: 100%;
            overflow:auto"> 
            <asp:DataGrid ID="dg_FormESR_My" runat="server" AllowPaging="false" CssClass="grd_body"
                Visible="True" AutoGenerateColumns="False" AllowSorting="true" OnDeleteCommand="dg_FormESR_My_DeleteCommand"
                OnItemCommand="dg_FormESR_My_ItemCommand"  OnSortCommand="dg_FormESR_My_SortCommand" >
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Print">
                        ...
                        <ItemTemplate>
                            <asp:ImageButton Visible="false" ID="imgPrint" CommandName="Print" runat="server"
                                ImageUrl="../img/print.ico" BorderWidth="0" Width="18px" Height="18px" />
                        </ItemTemplate>
                    </asp:TemplateColumn>
        ...
        <div id="Ert_AR" align="center" style="position: relative; width: 100%; height: 100%;
            ...
            <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 97%">
                <tr class="tr_common">
                    ...
                    <td style="width: 100px">
                        <asp:DropDownList ID="areatype" runat="server" DataValueField="groupID" AutoPostBack="True" CssClass="infaceDrop"
                            DataTextField="groupID" OnSelectedIndexChanged="Areatype_OnSelectedIndexChanged" AppendDataBoundItems="true">
                        </asp:DropDownList>
                    </td>
                    <td>&nbsp;</td>
            ...
            <div id="Ert_AR_data" align="center" style="position: relative; width: 100%; height: 90%;
              overflow:auto;">
              <asp:DataGrid ID="dg_FormESR_All" runat="server" AllowPaging="false" CssClass="grd_body"
                Visible="True" AutoGenerateColumns="False" AllowSorting="true" OnDeleteCommand="dg_FormESR_All_DeleteCommand"
                OnItemCommand="dg_FormESR_All_ItemCommand" OnSortCommand="dg_FormESR_All_SortCommand">
                <HeaderStyle CssClass="grd_head"></HeaderStyle>
                <ItemStyle CssClass="grd_item"></ItemStyle>
                <AlternatingItemStyle CssClass="grd_alitem"></AlternatingItemStyle>
                <FooterStyle CssClass="grd_fsitem"></FooterStyle>
