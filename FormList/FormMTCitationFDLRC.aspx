<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTCitationFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormMTCitationFDLRC" %>
        ...
        function doseltdbyflag(flag) {
            ...
            switch (flag) {
                ...
                case 3:
                    ...
                    document.Citation.CTypeFlag.value = "3";
                    break;
            }
        }
                        ...
                        <tr>
                            <td>
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        <td class="td_label">
                                            <b><asp:Label ID="Label14" runat="server" Text="Issues:" ></asp:Label></b></td>
                                    </tr>
                                    <tr style="height:5px;">
                                        <td>
                                        </td>
                                    ...
                                    <tr class="tr_common">
                                        <td class="td_label">
                                            <b><asp:Label ID="Label1" runat="server" Text="Corrections:" ></asp:Label></b></td>
                                    </tr>
                                    <tr style="height:5px;">
                                        <td>
                                        </td>
                                            ...
                                            <table class="table_inside">
                                                <tr class="tr_common">
                                                    <td  class="td_label" style="width: 350px">
                                                        <asp:Label ID="Label85" runat="server" Text="Due Date for Submission of Response/Proof of Correction:" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                                    </td>
                                                    <td class="td_label">
