<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.FormList.SearchIPPPlanFDLRC" CodeBehind="SearchIPPPlanFDLRC.aspx.cs" %>
        ...
        <table class="table_full" width="100%">
            ...
            <tr>
                <td style="width: 150px" align="right" width="80" bgcolor="#9fb0f4" height="20">
                    <b>Select Plan Category:</b>
                </td>
                <td width="5" height="20">
                </td>
                <td height="20" style="width: 350px">
                    <asp:DropDownList ID="SelCategory" runat="server" CssClass="infaceDrop" OnClick="DataChanged()"
                       OnSelectedIndexChanged="SelCategory_SelectedIndexChanged" AutoPostBack="true">
                          <asp:ListItem Value="">All</asp:ListItem>
                          <asp:ListItem Value="1">Child</asp:ListItem>
                          <asp:ListItem Value="3">Adult</asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td width="300px"></td>
            </tr>
