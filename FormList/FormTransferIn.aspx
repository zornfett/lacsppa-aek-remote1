<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormTransferIn.aspx.cs" Inherits="Virweb2.FormList.FormTransferIn" %>
...
<head>
    <base target="_self" /> 
    <title>::Inter Regional Center Transfer In:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
         ...
         function back_click() {
             document.location.replace('FormTransferInList.aspx');
         }
         ...
         function SCSign() {
             ...
             window.document.TransferIn.submit();
             window.focus();
         }
...
<body runat="server" id="body">
    ...
    <form id="TransferIn" runat="server">
        ...
        <table class="table_maindiv" width="100%">
                ...
                <td colspan="6">
                   <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%">
                       <tr style="height: 30px;" valign="middle">
                          <td align="left">
                             <asp:Label ID="Label11" runat="server" Font-Size="Small" Font-Bold="True" ForeColor="blue">
                               Click the 'Browse' button to select the file then click 'Upload Selected Document'</asp:Label>
                          </td>
                   ...
                   <table border="0" cellpadding="0" style="border-collapse: collapse" width="100%">
                       <tr style="height: 30px;" valign="middle" >
                         <td align="left">
                          ...
                          <td>
                            <input class="text" id="TransferPDF" type="file" name="TransferPDF" runat="server" style="width: 500px" />
                          </td>
                          <td>
                            <asp:Button ID="btnUpload" runat="server" Text="Upload Selected Document" CssClass="buttonbluestyle" 
                                OnClientClick="return upload_click();" OnClick="btnUpload_Click">
                            </asp:Button>
                          </td>
                       </tr>
                   </table> 
            ...
            <tr class="tr_common">
                <td style="width: 210px;" class="td_label">
                    <b><asp:Label ID="l_receiveddate" runat="server" Text="Received Date:"></asp:Label></b>
                </td>
                <td width="5">
                </td>
            ...
            <tr class="tr_common">
                ...
                <td  class="td_label"  style="width: 210px">
                    <b><asp:Label ID="l_casetransferfrom" runat="server" Text="From:"></asp:Label></b>
                </td>
                <td width="5" >
                </td>
                <td align="left" width="300">
                    <asp:DropDownList ID="casetransferfrom" runat="server" DataValueField="tb_entry_name" DataTextField="tb_entry_text"
                                         Width="235" OnChange="DataChanged()">
                    </asp:DropDownList>
                </td>
            </tr>
