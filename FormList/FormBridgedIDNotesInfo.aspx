<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormBridgedIDNotesInfo.aspx.cs" Inherits="Virweb2.FormList.FormBridgedIDNotesInfo" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/javascript">
        ...
        {
           if (Confirm_Page())
                document.location.replace("FormBridgedIDNotesInfo.aspx?type=add");
        }
        ...
        function List_click()
        {
            if (Confirm_Page())
            {
                var searchUCI = document.IDNotesInfo.searchUCI.value.toString();
                document.location.replace("FormBridgedIDNotesList.aspx?searchUCI=" + searchUCI); 
            }
        }
        ...
        { 
          ...
          winhref("../weblist/PrintIDNotesInfo.aspx?tx_uci=" + tx_uci + "&tx_date=" + tx_date + "&txty_type=" + txty_type + "&fromType=Bridged" + "&UserAct=" + UserAct, "PrintIDNotesInfo");        
        }
...
<body id="body" runat="server">
    ...
    <form id="IDNotesInfo" method="post" runat="server">
        ...
        <input type="hidden" name="searchUCI" id="searchUCI" value="" runat="server" />
        ...
        <div id="maindiv" align="center" style="position: relative; width: 100%; height: 650px; overflow: auto">
            <table class="table_maindiv">
                                ...
                                <td align="left" width="280" style="width: 280px">
                                  ...
                                  <tr>
                                    <td class="td_unline" align="left" width="80" style="width: 80px; height: 20px;">
                                      <asp:TextBox ID="tx_date" runat="server" CssClass="inface" Style="width: 80px"  onclick="showcalendar(event, this);" onfocus="showcalendar(event, this);" >
                                      </asp:TextBox>
                                    </td>
                                    <td width="5"></td>
                                    <td class="td_unline" align="left" width="80" style="width: 80px; height: 20px;">
                ...
                <tr>
                    <td  style="height: 80px" valign="top" height="80">
                        ...
                        <cc1:UltimateSpell ID="UltimateSpell1" ControlIdsToCheck="tx_id_notes" ShowModal="true" runat="server" >
                        </cc1:UltimateSpell>
                    </td>
                </tr>
                <tr>
            ...
            <table id="table_ebilling" runat="server" class="table_common" cellspacing="0" cellpadding="0"
                   ...
                   <tr class="tr_common">
                        <td colspan=8>
                            <table id="Table1" runat="server" class="table_common" cellspacing="0" cellpadding="0"
