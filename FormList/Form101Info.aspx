<%@ Page Language="C#" Inherits="Virweb2.FormList.Form101Info" CodeBehind="Form101Info.aspx.cs" AutoEventWireup="True" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        function print_click() {
            ...
            winhref("PrintForm101.aspx?id=" + key, "PrintForm101Info");
        }

        function submit_click() {
            if (IsDate(document.getElementById("dob").value, true) != "true") {
                alert("Please enter the Date of Birth (DOB)!");
                document.getElementById("dob").focus();
                return false;
            }

            try {
                return confirm("Do you want to submit this form?  It will be readonly after you submit.");
            }
            catch (err) {
...
<body id="body" runat="server" style="cursor:wait">
    ...
    <div id="maindiv" align="center" style="position: relative; width: 100%; overflow: auto;
        ...
        <table class="table_maindiv">
                    ...
                    <table class="table_inside">
                        <tr class="tr_common">
                            ...
                            <td  style="width:170px">
                                <asp:DropDownList ID="ServSC" Enabled="false" runat="server" DataValueField="employeeID" DataTextField="employeeName" 
                        ...
                        <tr  class="tr_common">
                            ...
                            <td  style="width: 120px">
                                <table class="table_inside">
                                    <tr>
                                        ...
                                        <td class="td_unline" width="25px">
                                            <asp:TextBox ID="phone_3_1" runat="server" CssClass="inface" MaxLength="3"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                        <td align="center" width="15px">
                                            )
                                        ...
                                        <td class="td_unline" width="25px">
                                            <asp:TextBox ID="phone_3_2" runat="server" CssClass="inface" MaxLength="3"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                        <td align="center" width="10px">
                                            -
                                        ...
                                        <td class="td_unline" width="30px">
                                            <asp:TextBox ID="phone_3_3" runat="server" CssClass="inface" MaxLength="4"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td  style="width: 120px">
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        <td  class="td_unline" width="40px">
                                            <asp:TextBox ID="phone_3_4" runat="server" CssClass="inface" MaxLength="5"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td  width="120px" style="font: bold; width: 120px;" class="td_label" align="center">
                                            <asp:CheckBox ID="casefile_pending" runat="server" />
                                        </td>
                                        <td  width="120px" style="font: bold; width: 120px;" class="td_label" align="center">
                                            <asp:CheckBox ID="casefile_received" runat="server" />
                                        </td>
                                        <td  class="td_unline" style="width:120px">
                                            <asp:TextBox ID="casefile_date" runat="server" CssClass="inface" onclick="showcalendar(event, this);DataChanged();"
                                                onfocus="showcalendar(event, this);" >
                                            </asp:TextBox>
                                        </td>
                                        <td style="width:auto"></td>
            ...
            <tr>
                <td>
                    <table id="developTB" class="table_inside" runat="server">
                        <tr>
                            <td>
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        <td  width="130px"  class="td_label" style="font: bold; width: 130px">
                                            <b>
                        ...
                        <tr class="tr_common">
                            ...
                            <td  style="width: 40px">
                                <table class="table_inside">
                                    <tr>
                                        <td class="td_unline" width="40px">
                                            <asp:TextBox ID="contact1_phone_2_4" runat="server" CssClass="inface" MaxLength="5"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <tr class="tr_common">
                            ...
                            <td  style="width: 40px">
                                <table class="table_inside">
                                    <tr>
                                        <td class="td_unline" width="40px">
                                            <asp:TextBox ID="contact2_phone_2_4" runat="server" CssClass="inface" MaxLength="5"
                                                TabIndex="2"></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
