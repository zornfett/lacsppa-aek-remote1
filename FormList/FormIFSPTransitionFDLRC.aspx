<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormIFSPTransitionFDLRC.aspx.cs" Inherits="Virweb2.FormList.FormIFSPTransitionFDLRC" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <!--
        ...
        function print_click() 
        {
            ...
            var url = "PrintFormIFSPTransitionFDLRC.aspx?TransID=" + entrykey + "&UserAct=" + UserAct;
            winhref(url, 'PrintFormIFSPTransitionFDLRC');
        }
                            ...
                            <td>
                                <table class="table_inside">
                                    <tr style="height:30px;">
                                        ...
                                        <asp:Label ID="Title12" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="blue">Transition Plan</asp:Label>
                                        </td>
                                          ...
                                          <table class="table_inside">
                                           <tr>
                                            ...
                                            <td  style="width: 120px" class="td_unline" >
                                               <asp:TextBox ID="MeetingDate" runat="server" CssClass="inface" onclick="DataChanged();showcalendar(event, this);" 
                                                  onfocus="DataChanged();showcalendar(event, this);"></asp:TextBox>
                                            </td>
                                            <td width="5" >
                                            </td>
                                            ...
                                            <td style="width: 200px" class="td_unline">
                                               <asp:DropDownList ID="SchoolDistrict" OnClick="DataChanged()" runat="server" DataValueField="Title" DataTextField="Name"
                                                 CssClass="infaceDrop">
                                               </asp:DropDownList>
                                            </td>
                                            <td width="5" >
