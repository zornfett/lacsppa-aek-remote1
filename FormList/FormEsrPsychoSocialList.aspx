<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormEsrPsychoSocialList.aspx.cs" Inherits="Virweb2.FormList.FormEsrPsychoSocialList" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >

<head>
    <base target="_self" />
    <title>:::ES Psycho Social List:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/javascript">
        ...
        {
            if (FDLRC==1)
               document.location.replace("FormEsrPsychoSocialFDLRC.aspx?c_key="+uci+"&type=add");
            else
               document.location.replace("FormEsrPsychoSocialInfo.aspx?c_key="+uci+"&type=add");
        }
        ...
        <div align="center" style="position: relative; width: 100%; height: 600px; overflow: auto">
            <asp:DataGrid ID="dg_EsrPsySocialList" runat="server" AllowPaging="false" CssClass="grd_body"
                ...
                <Columns>     
                    ...
                    <asp:BoundColumn DataField="EvaluationDate" HeaderText="Evaluation Date" DataFormatString="{0:MM/dd/yyyy}">
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
