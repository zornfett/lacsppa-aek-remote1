<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTCitation.aspx.cs" Inherits="Virweb2.FormList.FormMTCitation" %>
		...
		<table border="0" cellpadding="0" style="BORDER-COLLAPSE: collapse" width="99%" >
	        ...
	        <tr style="height: 25px;" align="center" valign="bottom">
			    ...
			    <td>
                    ...
                    onclick="winhref('./Report/PrintMTCitation.pdf','PrintMTCitation');return false;" />	
                </td>
		    </tr>				
