<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTDayProgramInfantSCLARC.aspx.cs" Inherits="Virweb2.FormList.FormMTDayProgramInfantSCLARC" %>
...
<head>
    <base target="_self" />
    <title>:::MONITORING TOOLS INFANT DAY PROGRAM:::...</title>
    ...
    <!--
        ...
        function DropDownListChange(Qno, CitaID)
        {
            ...
            if ((Value == 2) || (Value == 3)) 
            {
                ...
                {
                  var entrykey=document.MTInfo.entrykey.value.toString();
                  popupDialog("FormMTCitation.aspx?MTID=" + entrykey + "&FormType=Infant Day Program&Qno=" + Qno + "&type=add");
                }
            } 
            else
            {
        ...
        function checkTransport() {
          if (document.MTInfo.Transportation.value == "YES")
             document.MTInfo.TransportText.disabled = false;
          else 
             document.MTInfo.TransportText.disabled = true;
        }
                    ...
                    <table class="table_common" cellspacing="0" cellpadding="0" border="0" style="width: 100%;height:100%">
                                    ...
                                    <tr>
                                        <td valign="middle" align="center">
                                            <asp:Label ID="l_title" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue"
                                                Height="24px">ANNUAL INFANT DAY PROGRAM REVIEW</asp:Label>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td  style="width: 300px" class="td_unline" >
                                            <asp:DropDownList ID="FormType" runat="server" width="280px" CssClass="infaceDropText" Enabled="false">
                                                 <asp:ListItem Value="Infant Day Program" Selected="True">Annual Infant Day Program</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                            ...
                            <td>
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        ...
                                        <td  style="width: 300px" class="td_unline" >
                                            <asp:DropDownList ID="ProgramType" runat="server" CssClass="infaceDrop">
                                                <asp:ListItem Value=""></asp:ListItem>
                                                <asp:ListItem Value="Centered-Based Program">Centered-Based Program</asp:ListItem>
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside">
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 260px">
                                        ...
                                        <td  style="width: 60px" class="td_unline" >
                                            <asp:DropDownList ID="Transportation" runat="server" CssClass="infaceDrop" OnClick="checkTransport();">
                                                <asp:ListItem Value=""></asp:ListItem>
                                        ...
                                        <td  class="td_label" style="width: 60px">
                                            <asp:Label ID="Label14" runat="server" Text="If Yes:" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width:auto">
                                            <asp:TextBox ID="TransportText" runat="server" CssClass="inface" MaxLength="100" Enabled="false" ></asp:TextBox>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>GENERAL REQUIREMENTS [Title 17, 56770] Part H</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>PROGRAM DESIGN [Title 17, 56712/Goal 56712]</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>CHILD PLACEMENT (ELIGIBILITY) AND FUNDING PROCEDURES (Title 17, 56716, and 56718)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:30px;">
                            <td><b>CHILD SERVICE PLAN (SP) DOCUMENTATION (TITLE 17 SECTION 56762)</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr style="height:20px;" align="left">
                            <td><b>The child's file shall include</b></td>
                        </tr>
                        <tr style="height: 5px;">
                            <td>
                            </td>
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside" border="0"  cellspacing="0" cellpadding="0" style="border: 2px solid #CC99CC;">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q38" runat="server" Text="21. (a)" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q39" runat="server" Text="21. (b)" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside" border="0"  cellspacing="0" cellpadding="0" style="border: 2px solid #CC99CC;">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q40" runat="server" Text="21. (c)" Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q41" runat="server" Text="21. (d) " Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q42" runat="server" Text="21. (e) " Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside" border="0"  cellspacing="0" cellpadding="0" style="border: 2px solid #CC99CC;">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <asp:Label ID="l_Q43" runat="server" Text="21. (f) " Font-Bold="true"></asp:Label>
                                        </td>
                                        <td width="5">
                                        </td>
                                        <td style="width: 100px;" class="td_unline">
