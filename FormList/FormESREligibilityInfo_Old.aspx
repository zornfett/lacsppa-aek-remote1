<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormESREligibilityInfo_Old.aspx.cs" Inherits="Virweb2.FormList.FormESREligibilityInfo_Old" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        ...
        function print_click() {
            ...
            var consumer_key = document.ESREligInfo.consumer_key.value.toString();
            var url = "PrintFormESREligibilityInfo_Old.aspx?entrykey=" + entrykey + "&consumer_key=" + consumer_key + "&flag=" + flag + "&UserAct=" + UserAct;
                            ...
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline" style="width: 250px">
                                            <asp:Button ID="Button1" CssClass="buttonbluestyle" runat="server" Text="Refresh"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td style="width: auto"></td>
                                    </tr>
                                            ...
                                            <table class="table_inside">
                                                <tr class="tr_common">
                                                    ...
                                                    <td class="td_unline"  style="width: 60px">
                                                        <asp:Label ID="WeeksGestation" runat="server" Width="60px" CssClass="infaceText"></asp:Label>
                                                    </td>
                                                    <td style="width:10px">
                                                    </td>
                                                    <td  class="td_label" style="width: 30px">
                                                        <asp:Label ID="Label1" runat="server" Text="A.A:" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                                    </td>
                                                    ...
                                                    <td  class="td_label" style="width: 30px">
                                                        <asp:Label ID="Label20" runat="server" Text="C.A:" Font-Bold="true"></asp:Label>
                                                    </td>
                                                    <td width="5">
                                                    </td>
                                                    <td class="td_unline"  style="width: 150px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="EvaluationBy" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Cognitive_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="FineMotor_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="GrossMotor_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Receptive_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Expresstive_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Emotional_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_unline"  style="width: 250px">
                                            <asp:Label ID="Adaptive_Level" runat="server" Width="250px" CssClass="infaceText"></asp:Label>
                                        </td>
                                        <td style="width:20px">
                                        </td>
                                        <td class="td_unline"  style="width: 250px">
                        ...
                        <tr class="tr_common">
                            <td>
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="prog_dutto1" groupname="prog_dutto" runat="server" Text=""></asp:RadioButton>
                                            <b>Consumer is 0-23 months of age and has a significant DELAY (33%) in one or more developmental areas.</b>
                                        </td>
                                    </tr>
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="prog_dutto2" groupname="prog_dutto" runat="server" Text=""></asp:RadioButton>
                                            <b>Consumer is 24-36 months of age and has a significant DELAY (50%) in one developmental area.</b>
                                        </td>
                                    </tr>
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                            &nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="prog_dutto3" group="prog_dutto" runat="server" Text=""></asp:RadioButton>
                                            <b>Consumer is 24-36 months of age and has a significant DELAY (33%) in two or more developmental areas.</b>
                                        </td>
                                    </tr>
                                    <tr class="tr_common">
                                        <td  class="td_label" style="width: 100%">
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <b><asp:Checkbox ID="not_early_prog_eligible" runat="server" Text=""></asp:Checkbox>NOT ELIGIBLE for the Early Start Program, however is:</b>	
                                    ...
                                    <tr class="tr_common">
                                        <td  class="td_label">
                                            <b><asp:Checkbox ID="prevent_resource_eligible" runat="server" Text=""></asp:Checkbox>ELIGIBLE for the Prevention Resource and Referral Program due to:</b>	
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                ...
                                <table class="table_inside">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="speech_evaluation" runat="server" Text=""></asp:Checkbox>Evaluation
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:TextBox ID="other_reason" runat="server" CssClass="inface" Width="400px" MaxLength="100"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr style="height: 5px;">
                                        <td>
                                    ...
                                    <tr class="tr_common">
                                        <td class="td_label"  style="width:49%">
                                            <asp:Checkbox ID="developmental_evaluation" runat="server" Text=""></asp:Checkbox><b>Developmental Evaluation</b>
                                        </td>
                                        <td style="width: 2%"></td>
                                        <td class="td_label"  style="width:49%">
                                    ...
                                    <tr class="tr_common">
                                        ...
                                        <td class="td_label"  style="width:49%">
                                            ...
                                            <asp:Checkbox ID="oph_consult" runat="server" Text=""></asp:Checkbox><b>Behavior Consult</b>
