<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="FormMTList.aspx.cs" Inherits="Virweb2.FormList.FormMTList" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/javascript">
        function add_click(rid) {
            if (document.MTList.DefRegName.value == "FDLRC")
                ...
                window.showModalDialog("FormMTSelFormTypeSCLARC.aspx", self, "status:no;dialogWidth:500px;dialogHeight:400px;help:no;scroll:no;resizable:yes;");
        }
        function back_click() {
        ...
        <div align="center" style="position: relative; width: 100%; height: 600px; overflow: auto">
            ...
            <asp:DataGrid ID="dg_FormMTList" runat="server" AllowPaging="false" CssClass="grd_body"
                ...
                <Columns>     
                    ...
                    <asp:BoundColumn DataField="r_resource_name" HeaderText="Program Name" >
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="MonitoringDate" HeaderText="Review Date" DataFormatString="{0:MM/dd/yyyy}">
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
                    <asp:BoundColumn DataField="FormTypeStr" HeaderText="Type of Form" >
                        <ItemStyle HorizontalAlign="left" VerticalAlign="middle" />
                    </asp:BoundColumn>
