<%@ Page Language="C#" AutoEventWireup="true" Inherits="Virweb2.ReportList.ReportTransCaseLogMgn" Codebehind="ReportTransCaseLogMgn.aspx.cs" %>
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           */
           ...
           caseval1 = "3";
           caseval2 = "AA2";
           winhref("PrintTransCaseLogRptMgn.aspx?startdate="+stdate+"&enddate="+enddate+"&case1="+caseval1+"&case2="+caseval2, "PrintTransCaseLogRptMgn");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                        Manager Transfer Service Case Log Report</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
