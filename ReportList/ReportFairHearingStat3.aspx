<%@ page language="C#" inherits="Virweb2.ReportList.ReportFairHearingStat3" Codebehind="ReportFairHearingStat3.aspx.cs" %>
...
<head>
      <base target="_self" />
      <title>:::Fair Hearing Statistic Report 3:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">	
	  ...
	  <!--
        function print_report()
        {
           ...
           winhref("PrintFairHearingStat3.aspx?startdate="+StartDate+"&EndDate="+EndDate+"&SrvrType="+SrvrType,"PrintFairHearingStat3");           
        }
      //-->  
    </script> 
</head>
<body >
    ...
    <form id="form1" runat="server">
         <center>
          <br />
         <asp:label id="InfoTitle" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue">Fair Hearing Statistical Report 3</asp:label>
          <br />
          <br />
