<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="ReportPropertyChange.aspx.cs" Inherits="Virweb2.ReportList.ReportPropertyChange" %>
...
<head>
    <base target="_self" />
    <title>:::Property Status Changes:::.....</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
            function print_report() {
                ...
                var edate;
                edate = document.form1.enddate.value;
                winhref("PrintPropertyChange.aspx?startdate="+stdate+"&enddate="+edate, "PrintPropertyChange");
            }
    </script>
</head>
<body>
