<%@ page language="C#" inherits="Virweb2.ReportList.ReportFairHearingStat2" Codebehind="ReportFairHearingStat2.aspx.cs" %>
...
<head>
      <base target="_self" />
      <title>:::Fair Hearing Statistic Report 2:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">	
	  ...
	  <!--
        ...
        {
           var StartDate,EndDate,SrvrType;
           StartDate=document.form1.startdate.value;
           EndDate=document.form1.enddate.value;
           SrvrType = document.form1.srvrtype.value;
           winhref("PrintFairHearingStat2.aspx?startdate="+StartDate+"&EndDate="+EndDate+"&SrvrType="+SrvrType,"PrintFairHearingStat2");           
        }
      //-->  
    </script> 
</head>
<body >
    ...
    <form id="form1" runat="server">
         <center>
          <br />
           <asp:label id="InfoTitle" runat="server" Font-Size="Larger" Font-Bold="True" ForeColor="Blue">Fair Hearing Statistical Report 2</asp:label>
          <br />
          <br />
