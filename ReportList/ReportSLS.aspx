<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportSLS" Codebehind="ReportSLS.aspx.cs" %>
...
<head>
    <base target="_self" />
    <title>:::SLS Questionnaire Report:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           winhref("PrintSLS.aspx?startdate="+stdate+"&enddate="+enddate+"&groupid="+groupid, "PrintSLS");           
        }
    </script>
</head>
