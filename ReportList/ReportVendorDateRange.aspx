<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportVendorDateRange" Codebehind="ReportVendorDateRange.aspx.cs" %>
...
<head>
    <base target="_self" />
    <title>:::Vendor List Report:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           winhref("PrintVendorDateRange.aspx?startdate="+stdate+"&enddate="+enddate, "PrintVendorDateRange");           
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             ...
             <tr style="height:25px">
                 <td width="200px">Vendorization Date Start:&nbsp;&nbsp;&nbsp;</td>
              ...
              <tr style="height:25px">
                 <td width="200px">Vendorization Date End:&nbsp;&nbsp;&nbsp;</td>
                 <td class="td_unline" align="left" width="300px">
