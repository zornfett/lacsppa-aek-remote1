<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportTransCaseLogSumOut" Codebehind="ReportTransCaseLogSumOut.aspx.cs" %>
...
<head>
    ...
    <title>:::Transportation Service Case Log Outgoing Summary:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script language="javascript">
        function print_report()
        {
           ...
           */
           winhref("PrintTransCaseLogRptSumOut.aspx?startdate="+stdate+"&enddate="+enddate, "PrintTransCaseLogRptSumOut");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                        Transfer Service Outgoing Case Log Regional Center Summary</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
