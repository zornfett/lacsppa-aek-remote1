<%@ Page Language="C#" AutoEventWireup="true" Inherits="Virweb2.ReportList.ReportTransCaseLogSumIn" Codebehind="ReportTransCaseLogSumIn.aspx.cs" %>
...
<head>
    <base target="_self" />
    <title>:::Transportation Service Case Log Income Summary:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           */
           winhref("PrintTransCaseLogRptSumIn.aspx?startdate="+stdate+"&enddate="+enddate, "PrintTransCaseLogRptSumIn");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                        Transfer Service Income Case Log Regional Center Summary</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
