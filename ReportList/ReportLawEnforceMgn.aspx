<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportLawEnforceMgn" Codebehind="ReportLawEnforceMgn.aspx.cs" %>
...
<head>
    <base target="_self" />
    <title>:::Law Enforcement Liaison Manager Report:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script language="javascript">
        function print_report()
        {
           ...
           */
           winhref("PrintLawEnforceRptMgn.aspx?startdate="+stdate+"&enddate="+enddate, "PrintLawEnforceRptMgn");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                        Law Enforcement Liaison Manager Report</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
