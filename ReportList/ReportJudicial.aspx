<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportJudicial" Codebehind="ReportJudicial.aspx.cs" %>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           winhref("PrintJudicial.aspx?startdate="+stdate+"&enddate="+enddate, "PrintJudicial");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                         Judicially Involved Consumers List</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
