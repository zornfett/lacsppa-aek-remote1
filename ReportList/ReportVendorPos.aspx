<%@ Page Language="C#" AutoEventWireup="True" Inherits="Virweb2.ReportList.ReportVendorPos" Codebehind="ReportVendorPos.aspx.cs" %>
...
<head>
    <base target="_self" />
    <title>:::Other Vendor Utilization Report:::...</title>
...
<link rel="stylesheet" href="../css/style-2020a.css">
    ...
    <script type="text/JavaScript">
        function print_report()
        {
           ...
           var RCID;
           RCID = document.form1.txt_group.value;
           winhref("PrintVendorPos.aspx?startdate="+stdate+"&enddate="+enddate+"&rcid="+RCID, "PrintVendorPos");           
        }
    </script>
</head>
        ...
        <table cellspacing="0" cellpadding="0" align="center" border="0" style="width: 80%">
             <tr style="height:30px">
                 <td colspan="3" align="center" style="font-family: Arial"><h3>
                        Other Regional Center Vendor Utilization Report</h3>
                 </td>
             </tr>            
             <tr style="height:30px">
                 <td colspan="3"></td>
             ...
             <tr style="height:25px">
              ...
              <tr style="height:25px">
                 <td width="150px">Please Select a Regional Center:</td>
                 <td class="td_unline" align="left" width="300px">
                     <asp:DropDownList ID="txt_group" runat="server" DataValueField="RC_ID" DataTextField="RC_Name"
                                        Height="25" Width="260" >
                     </asp:DropDownList>
                 </td>
